...
// @version 6.2
// @description Всё, что тебе когда-либо понадобиться для BC
// @author Nemesea
...
(async function() {
    ...
    let tgpr3;
    let tgpr4;
    const umsg1 = "Ваша команда не может быть выполнена, поскольку";
    const umsg2 = " использует Uwall-защиту.";
    const umsg3 = 'вы находитесь в режиме "без побега".';
    const umsg4 = "Ваше сообщение не может быть отправлено, поскольку оно противоречит правилам общения кукол.";
    const umsg5 = "Данная комната не имеет карту.";
    const umsg6 = " Лучше используйте команду <b>/uroom</b>.";
    const umsg7 = "у вас включён тихий режим.";
    const umsg8 = "Сильно затянутый ошейник или LSCG-заклинание не позволяет вам говорить.";
    ...
    let animalmode1 = ["ху", "хонк", "хуинк", "хойинк", "хум", "юм", "хуумм", "юуум"]; // сова
	let animalmode2 = ["мо", "муу", "мууу", "му", "муу", "муууу"]; // корова
	let animalmode3 = ["виф", "йиф", "вииф", "йииф", "вифф", "йифф", "ау", "вау", "авау"]; // лиса
	let animalmode4 = ["мяу", "мяяу", "мяуу", "мияу", "мияяу", "мяв", "мя-ау"]; // кошка
	let animalmode5 = ["ку", "куи", "куик", "куи", "куии", "скуи", "скуик"]; // мышь/писк
	let animalmode6 = ["хрю", "хрюк", "хр", "хрр", "хрю-ю", "хррр"];
	let animalmode7 = ["хр", "хра", "хрих", "хррр", "кхрр"];
	let animalmode8 = ["вуф", "аф", "ауф", "вууф", "аву", "авуу", "вуу", "рафф", "вруф"];
	let animalmode9 = ["ово", "овоо", "хуу", "овуууу", "хаул", "хаулл", "хуул"];
	...
	let M_MOANER_defaultMoans = {
		"hot": ["О-о-ох...~", "М-м-ммх!", "Ммн... да...~", "А-а-ах...~", "М-м-мх..!", "О-ох... ммм...~", "Ммх...", "М-м-м... ах...", "Мгх... а!", "Ммгх...\u2665", "Ах... м-мгх!", "Мгх... м-м-м...~"],
    ...
    async function runUBC() {
        ...
        const UBC_TIPS = [
            "Открой для себя новые горизонты с опциями и командами UBC!",
            "Совет: Используй команду /uhelp в чате или изучи вики, чтобы лучше узнать все команды UBC.",
            "Наслаждайся всеми возможностями и командами UBC!"
        ]
        ...
        Player.UBC.ubcSettings.ListChat1 = ListChat1;
        ...
        Player.UBC.ubcSettings.ListChat2 = ListChat2;
        ...
        Player.UBC.ubcSettings.ListOnline = ListOnline;
        ...
        async function settingsPage() {
            ...
            const ubcSettingCategoryLabels = {
                UBCBackgrounds: "Задний фон",
                UBCButtons: "Кнопки",
                UBCCheats: "Читы",
                UBCHotkeys: "Горячие клавиши",
                UBCMaps: "Карты",
                UBCMisc: "Разное",
                UBCMoaner: "Стоны",
                UBCReputation: "Репутация",
                UBCSkills: "Навыки",
                UBCSpecialModes: "Специальные Режимы",
                UBCTalking: "Общение",
                UBCVisual: "Визуал"
            };
		...
		menuElements[UBCPreferenceSubscreen].push({
            ...
            PreferenceSubscreenUBCSettingsRun = function() {
                ...
                DrawButton(1815, 75, 90, 90, "", "White", "Icons/Exit.png");
                MainCanvas.textAlign = "left";
                DrawText("- ULTRA Bondage Club настройки -", 500, 125, "Black", "Gray");
                MainCanvas.textAlign = "center";
                ...
                DrawButton(1500, 760, 315, 90, "", "White", "", "Открыть вики Ultra BC на GitHub");
                DrawImageResize("Icons/Introduction.png", 1510, 775, 60, 60);
                DrawTextFit("UBC Вики", 1685, 808, 308, "Black");
                DrawText("/uhelp в чат", 1665, 880, "Black", "Gray");
		...
		PreferenceSubscreenResetExit = function () {
            ...
            PreferenceSubscreenUBCBackgroundsLoad = function() {
                ...
                addMenuCheckbox(64, 64, "Отключить цвет фона для сообщений UBC: ", "noubccolor",
					"Если вы отметите эту настройку, UBC не будет использовать определённый жёстко заданный цвет в качестве фона для своих локальных сообщений в чат-комнатах.", false, 200
				);
				addMenuCheckbox(64, 64, "Расширенное использование фона из Информации о Персонаже: ", "ifext",
					"На экране Информации о Персонаже у вас есть кнопки для случайного или ручного выбора фона, который заменяет стандартный фон. Выбранный фон также автоматически применяется к экранам BCX. Если вы отметите эту настройку, UBC распространит этот фон на следующие экраны: Заголовок, Профиль и Настройки (также для большинства аддонов), но эффект не будет мгновенным (вам нужно вернуться в меню Расширений!)", false, 200
				);
				addMenuCheckbox(64, 64, "Убрать кнопки фона в Информации о Персонаже: ", "noifbuttons",
					"Если вы отметите эту настройку, UBC не будет отображать кнопки фона на экране Информации о Персонаже. Однако ваши текущие настройки останутся активными. ВАЖНОЕ ПРИМЕЧАНИЕ: Если вы хотите использовать инструмент Likolisu для смены фона этого экрана, вам нужно сначала нажать на кнопку «Фон по умолчанию» перед включением этой опции.", false, 200
				);
				addMenuCheckbox(64, 64, "Убрать кнопки фона в Таймер-Комнате: ", "notcbuttons",
					"Если вы отметите эту настройку, UBC не будет отображать кнопки фона в Таймер-Комнате. Однако ваши текущие настройки останутся активными.", false, 200
				);
				addMenuCheckbox(64, 64, "Убрать кнопки фона в Гардеробе: ", "nowrbuttons",
					"Если вы отметите эту настройку, UBC не будет отображать кнопки фона в Гардеробе. Однако ваши текущие настройки останутся активными. ВАЖНОЕ ПРИМЕЧАНИЕ: Если вы хотите использовать инструмент Likolisu для смены фона этого экрана, вам нужно сначала нажать на кнопку «Фон по умолчанию» перед включением этой опции.", false, 200
);
            }
            ...
            PreferenceSubscreenUBCButtonsLoad = function() {
                ...
                addMenuCheckbox(64, 64, "Включить кнопку Настроек в чат-комнатах: ", "extbuttons",
					"Когда отмечено, в чат-комнатах будет добавлена кнопка Настроек.", false, 150
				);
				addMenuCheckbox(64, 64, "Включить кнопки ОСВОБОДИТЬСЯ: ", "sosbuttons",
					'Кнопка ОСВОБОДИТЬСЯ добавляется в чат-комнату, тюрьму Пандоры, фото-комнату и таймер-комнату. Она соответствует команде /totalrelease, но только для себя. Стандартное сообщение в чат-комнатах для этой кнопки может быть заменено на пользовательское сообщение или на отсутствие сообщения — смотрите команду /message. Эта опция недоступна в режиме "без побега".', "Player.UBC.ubcSettings.noescape", 150
				);
				addMenuCheckbox(64, 64, "Включить кнопки ВЫЙТИ: ", "outbuttons",
					'Кнопка ВЫЙТИ добавляется в чат-комнату, тюрьму Пандоры, фото-комнату и таймер-комнату. Она соответствует команде /quit, но без дополнительного опционального текста. Эта опция недоступна в режиме "без побега".', "Player.UBC.ubcSettings.noescape", 150
				);
				let slowmsg = 'По умолчанию вы покидаете чат-комнату или другую локацию с помощью кнопки ВЫЙТИ в быстром режиме, даже если вы связаны. Когда вы включаете эту опцию, вы будете выходить в медленном режиме без специальной иконки под вашим персонажем, что удивит других игроков! Эта опция недоступна в режиме "без побега". ';
				let notesc = 0;
				if (Player.UBC.ubcSettings.noescape == false) notesc = 1;
				if (notesc == 0) {
					addMenuCheckbox(64, 64, "Медленный выход с кнопкой ВЫЙТИ: ", "slowleave", slowmsg, true, 150);
				} else {
					addMenuCheckbox(64, 64, "Медленный выход с кнопкой ВЫЙТИ: ", "slowleave", slowmsg, "!Player.UBC.ubcSettings.outbuttons", 150);
				}
				addMenuCheckbox(64, 64, "Включить кнопку РУИР в чате: ", "rglbuttons",
					"Кнопка РУИР даёт информацию о вашем текущем Реальном Уровне Искажения Речи в любой момент, проверяя надетые кляпы и другие предметы, ограничивающие речь (включая ошейник LSCG и заклинания). При использовании кнопок, горячих клавиш или команд для освобождения эта информация автоматически выдаётся и синхронизируется с вашим принудительным уровнем кляп-речи/шёпота, так как результат равен 0. Кнопку РУИР можно использовать как экстренную меру, когда вы не можете говорить, не будучи в кляпе, например.", false, 150
				);
				addMenuCheckbox(64, 64, "Расширенная синхронизация с кнопкой РУИР:", "rglsync",
					"По умолчанию синхронизация кнопки РУИР с принудительным уровнем кляп-речи/шёпота происходит автоматически при использовании экстренных кнопок, горячих клавиш или команд для освобождения. Эта настройка позволяет расширить её на все остальные ситуации. Обнаруженный уровень будет ограничен 10 для кляп-речи (11 используется для лепета). При включении ручные изменения надетых кляпов и других предметов, ограничивающих речь (включая ошейник LSCG и заклинания), требуют повторного нажатия кнопки РУИР.", "!Player.UBC.ubcSettings.rglbuttons", 150
				);
            }
            ...
            PreferenceSubscreenUBCCheatsLoad = function() {
                ...
                addMenuButton(150, 64, "Добавить/Убрать Дополнительные Карты для Карточной Игры:", "Переключить", function() {
						...
						if (Player.UBC.ubcSettings.cextra == false) {
							...
							PreferenceMessage = "Все дополнительные карты добавлены";
						} else {
							Player.UBC.ubcSettings.cextra = false;
							PreferenceMessage = "Все дополнительные карты убраны";
						}
						ServerAccountUpdate.QueueData({
							Game: Player.Game
						}, true);
					},
					"Эта настройка является переключателем. Вы можете добавить или убрать все наградные дополнительные карты. Обратите внимание, что дополнительные карты, полученные вами обычным путём, также будут убраны, когда эта настройка переключится на действие удаления.", 140
				);
				addMenuCheckbox(64, 64, "Всегда доступ к меню многослойности: ", "layerall",
					"С этой опцией у вас всегда будет доступ к меню многослойности, даже если связывания и замки ограничивают ваши движения! Примечание: Если вы не хотите, чтобы другие игроки вносили изменения в вашего персонажа через многослойность, вы можете включить соответствующую опцию в моде WCE.", false, 160
				);
				addMenuCheckbox(64, 64, "Включить чит для Бондажной Драки/Школы Магии: ", "magiccheat",
					"С этой опцией вы всегда будете победителем в Бондажной Драке и Школе Магии (только в одиночной игре)!", false, 160
				);
				addMenuCheckbox(64, 64, "Включить дополнительную информацию о некоторых замках: ", "extrainfo",
					"Эта настройка позволяет использовать команду /infolock и получать таким образом дополнительную информацию (код, пароль, оставшееся время) о некоторых замках на надетом предмете в слоте, выбранном кликом по себе или другому игроку.", false, 160
				);
				addMenuCheckbox(64, 64, "Включить полную помощь для сложных замков и замков высокого уровня безопасности: ", "fullseed",
					"С этой опцией вы станете экспертом по взлому замков! Полное решение с правильным порядком взлома сложных замков и замков высокого уровня безопасности отображается на экране.", false, 160
				);
                let gmsg = "Эта настройка позволяет убрать искажение вашей не-принудительной кляп-речи, независимо от сложности игры. Однако она недоступна, если вы включили соответствующую функцию WCE, которая имеет больше опций.";
				let smsg = "Эта настройка позволяет автоматическую борьбу в мини-играх, независимо от сложности игры. Если автоборьба не срабатывает, вам нужно изменить прочность надетых предметов с помощью команды /solidity и/или улучшить свои навыки с помощью команды /boost. Обратите внимание, что эта настройка недоступна, если вы включили соответствующую функцию WCE, которая работает немного иначе.";
                let gbc = 0;
                let sbc = 0;
				...
				if (gbc == 0) {
					addMenuCheckbox(64, 64, "Включить устранение искажения вашей кляп-речи: ", "nogarble", gmsg, false, 160);
				} else {
					addMenuCheckbox(64, 64, "Включить устранение искажения вашей кляп-речи: ", "nogarble", gmsg, true, 160);
				}
				if (sbc == 0) {
					addMenuCheckbox(64, 64, "Включить автоматическую борьбу в мини-играх: ", "nostruggle", smsg, false, 160);
				} else {
					addMenuCheckbox(64, 64, "Включить автоматическую борьбу в мини-играх: ", "nostruggle", smsg, true, 160);
				}
            }
            ...
            PreferenceSubscreenUBCHotkeysLoad = function() {
				...
				addMenuCheckbox(64, 64, "Включить горячие клавиши в чат-комнатах: ", "hotkeys",
					'Эти горячие клавиши эквивалентны команде /quit, но без дополнительного опционального текста, и команде /totalrelease, но только для себя.                         Горячие клавиши на цифровой клавиатуре:         Divide = быстрый выход               Multiply = полное освобождение                    Если у вас нет цифровой клавиатуры, используйте вместо этого аналогичную команду или кнопку UBC. Эта опция недоступна в режиме "без побега".', "Player.UBC.ubcSettings.noescape"
				);
				addMenuCheckbox(64, 64, "Включить горячие клавиши в поиске чата: ", "cskeys",
					"Когда эта опция включена, у вас будет прямой доступ к некоторым полезным экранам, а также возможность менять фон Поиска Чата       Left Alt = Настройки                  Left Arrow = Гардероб                 Right Arrow = Расширения             Up Arrow = Случайный фон Down Arrow = Выбор фона Tab = Фон по умолчанию"
				);
				addMenuCheckbox(64, 64, "Включить горячие клавиши в списке друзей: ", "frkeys",
					"Эти горячие клавиши позволяют получить кликабельные ссылки на другое лобби, к которому у вас есть доступ, если вы находитесь в лобби (не в комнате). Вы можете использовать их только в списке текущих онлайн-друзей И если вы не находитесь в поле ввода поиска или зоне отправки сигнала. Фон также можно менять. Список доступных горячих клавиш:                D = Фон по умолчанию                  F = Женский клуб    G = Смешанный клуб  H = Мужской клуб        J = Убежище       R = Случайный фон              S = Выбор фона"
				);
			}
            ...
            PreferenceSubscreenUBCMapsLoad = function() {
				...
				addMenuCheckbox(64, 64, "Добавлять игрушки под запертое целомудрие в ловушках: ", "magictoys",
					"Включите эту опцию, если вы согласны с тем, что ловушки в комнатах карты могут добавлять игрушки под запертое целомудрие, со всеми последствиями, которые могут возникнуть позже, например, у вашего владельца или возлюбленных!", false, 140
				);
				addMenuInput(200, "Выбранная ловушка-устройство (0-9):", "maptrap1", "InputDeviceTrap",
					"Введите число от 0 до 9, чтобы выбрать ловушку-устройство: 0 Нет ловушки-устройства - 1 Бондажная скамья - 2 Гроб - 3 Демонстрационная рама - 4 Конура - 5 Шкафчик - 6 Тележка - 7 Деревянный ящик - 8 X-Крест - 9 ВСЕ ЛОВУШКИ-УСТРОЙСТВА. Когда ловушка включена, вы будете автоматически связаны, если наступите на устройство!", 6
				);
				addMenuCheckbox(64, 64, "Включить полный слух на картах: ", "mapfull2",
					"Когда включено, нет никаких ограничений для вашего слуха в комнатах карты", false, 140
				);
				addMenuCheckbox(64, 64, "Включить полное зрение на картах: ", "mapfull",
					"Когда включено, вы можете видеть комнаты карты целиком, без тумана. Примечания: команда /mapfog, которая включает/отключает туман только в текущей комнате карты, не имеет никакого эффекта, если эта настройка активна. Если вы не использовали /mapfog для удаления тумана перед включением этой настройки, туман вернётся при её отключении.", false, 140
				);
				addMenuCheckbox(64, 64, "Включить полный шёпот на картах: ", "nowhrange",
					"Когда включено, вы можете шептать любому игроку на карте, независимо от расстояния между вами и этим игроком. Это работает со стандартной командой BC /whisper и командой UBC /murmur между всеми игроками, включившими эту опцию.", false, 140
				);
				addMenuCheckbox(64, 64, "Включить магическую ходьбу на картах: ", "mapcheat",
					"Когда включено, вы можете ходить везде по картам, а также проходить сквозь стены, даже не будучи администратором!", false, 140
				);
				addMenuCheckbox(64, 64, "Отключить принудительную телепортацию на картах: ", "noteleport",
					"Когда отмечено, команды BC, связанные с принудительной телепортацией на картах, не будут действовать на вас, за исключением случаев, когда хотя бы один администратор чат-комнаты находится в вашем Tplist (смотрите команды /tplistadd, /tplistremove и /tplistshow).", false, 140
				);
			}
            ...
            PreferenceSubscreenUBCMapsExit = function() {
                ...
                if ((CommonIsNumeric(device)) && (profile > -1) && (device < 10)) {
                    ...
                    defaultExit();
                } else PreferenceMessage = "Введите корректное число";
            }

            PreferenceSubscreenUBCMiscLoad = function() {
				UBCPreferenceSubscreen = "UBCMisc";
				addMenuCheckbox(64, 64, "Алфавитный порядок для меню Настроек: ", "alfmenu",
					"Когда включено, все опции главного меню Настроек будут упорядочены в алфавитном порядке, за исключением Общих Настроек.", false, 140
				);
				addMenuCheckbox(64, 64, "Алфавитный порядок для экранов Настроек: ", "alfaprf",
					"С этой опцией большинство настроек на некоторых экранах Настроек будут в алфавитном порядке (в соответствии с английским текстом) по типу настройки (выпадающие списки, флажки). Эти экраны будут упорядочены: Общие, Аудио, Чат, Графика, Погружение и Онлайн.", false, 140
				);
				addMenuCheckbox(64, 64, "Алфавитный порядок для Репутации и Навыков: ", "alfrpsk",
					"Когда включено, большая часть информации о репутации и навыках на экране Информации о Персонаже будет упорядочена в алфавитном порядке. Обратите внимание, что репутация как доминанта или сабмиссива останется отображаться на первой позиции.", false, 140
				);
				addMenuCheckbox(64, 64, "Отключить все тревожные сообщения BCX: ", "nobcxalarm",
					"Выбрав эту опцию, вы больше не будете видеть тревожные сообщения BCX. Если у вас возникнут проблемы при использовании BC, проверьте консоль на наличие сообщений об ошибках.", false, 140
				);
				addMenuCheckbox(64, 64, "Включить ограничения Психушки: ", "asylumlimit",
					"По умолчанию UBC отключает ограничения Психушки (доступ, выход). Если вам нравятся эти ограничения, вы можете снова включить их с помощью этой опции.", false, 140
				);
	
				addMenuCheckbox(64, 64, "Включить наказания от NPC: ", "npcpunish",
					"По умолчанию UBC отключает автоматические наказания от NPC (особенно когда вы связаны в комнате и зовёте горничную на помощь). Если вам нравятся эти наказания, вы можете снова включить их с помощью этой опции.", false, 140
				);
				addMenuCheckbox(64, 64, "Не показывать ожидающих друзей в Списке Друзей: ", "nopending",
					"Когда отмечено, экран «Все Друзья» в Списке Друзей не будет отображать ожидающих (неподтверждённых) друзей.", false, 140
				);
				addMenuCheckbox(64, 64, "Не менять разрешения после стоп-слова: ", "fixperm",
					"BC автоматически меняет ваше общее разрешение на предметы, когда вы используете команду стоп-слова BC или опцию возврата в меню стоп-слова. Если вам это не нравится, используйте эту опцию, и ваше общее разрешение на предметы не будет изменено.", false, 140
				);
				addMenuCheckbox(64, 64, "Использовать только дни на экранах Информации о Персонаже: ", "onlydays",
					"BC автоматически конвертирует дни в годы, месяцы и дни. Если вам это не нравится, используйте эту опцию, чтобы эти данные отображались только в днях на экранах Информации о Персонаже.", false, 140
				);
			}
            ...
            PreferenceSubscreenUBCMoanerLoad = function() {
				...
				addMenuCheckbox(64, 64, "Активировать Стоны (Moaner): ", "script",
					"Добавьте больше веселья в Bondage Club со стонами!", false, 140
				);
				addMenuInput(200, "Профиль стонов (0-10):", "profile", "InputMoanProfile",
					"Введите число от 0 до 10, чтобы выбрать один из профилей стона: 0 По умолчанию - 1 Крольчиха - 2 Корова - 3 Собака - 4 Лиса - 5 Мышь - 6 Неко - 7 Свинья - 8 Пони - 9 Дикая лиса - 10 Волк.", 6
				);
				let omsg = "Когда включено, вы будете стонать при оргазме. Невозможно включить, если обнаружена включённой функция Брызги (Splatter) из LSCG.";
				let spl = 0;
				...
				if (spl == 0) {
					addMenuCheckbox(64, 64, "Включить стон при оргазме: ", "orgasmMoan", omsg, false, 140);
				} else {
					addMenuCheckbox(64, 64, "Включить стон при оргазме: ", "orgasmMoan", omsg, true, 140);
				}
				addMenuCheckbox(64, 64, "Включить стон при шлепках: ", "spankMoan",
					"Когда включено, вы будете стонать, когда вас шлёпают. Также при укусах, пинках, щипках, ударах током, пощёчинах. В случае действий, вызывающих шок, это касается только действий по наказанию за оргазм, попытку встать или сопротивление. В зависимости от ваших фетишей и уровня возбуждения, это может быть боль или удовольствие.", false, 140
				);
				addMenuCheckbox(64, 64, "Включить стон при разговоре: ", "talkMoan",
					"Когда включено, вы будете стонать во время разговора, если на вас вибратор. Стоны могут прерывать вашу речь. Обратите внимание: когда вы отключаете эту настройку, она автоматически отключает и стон при шёпоте.", false, 140
				);
				addMenuCheckbox(64, 64, "Расширить стон при разговоре на шёпот: ", "whisperMoan",
					"Когда включено, вы будете стонать во время шёпота, если на вас вибратор. Стоны могут прерывать ваш шёпот. Обратите внимание: эта настройка не может быть включена, когда стон при разговоре отключён.", "!Player.UBC.ubcSettings.talkMoan", 140
				);
				addMenuCheckbox(64, 64, "Включить стон при щекотке: ", "tickleMoan",
					"Когда включено, вы будете стонать, когда вас щекочут. В зависимости от ваших фетишей и уровня возбуждения, это может быть боль или удовольствие.", false, 140
				);
				addMenuCheckbox(64, 64, "Включить стон от вибраторов: ", "vibeMoan",
					"Когда включено, вы будете стонать, если настройки вашего вибратора меняются и ваш уровень возбуждения выше или равен 10. Также при пальцевой стимуляции, фистинге, мастурбации, или когда ваши уши ласкают, целуют, лижут, покусывают, или при использовании афродизиака-инъектора, напитка, респиратора из LSCG. Обратите внимание: когда вы отключаете эту настройку, она автоматически отключает и xvibes-стон.", false, 140
				);
				addMenuCheckbox(64, 64, "Расширить стон от вибраторов (xvibes-стон): ", "xvibeMoan",
					"Когда включено, вы будете стонать, когда настройки вибраторов других игроков в чат-комнате меняются, даже если на вас нет вибратора (единственное условие — уровень возбуждения выше или равен 10). Обратите внимание: эта настройка не может быть включена, когда стон от вибраторов отключён.", "!Player.UBC.ubcSettings.vibeMoan", 140
				);
			}
			...
			PreferenceSubscreenUBCReputationLoad = function() {
				...
				addMenuInput(200, "Основная репутация (от -100 до 100):", "rpmain", "InputRpMain",
					"Введите число от -100 до 100, чтобы установить ваш уровень основной репутации! Отрицательное число означает, что вы Сабмиссив, положительное число означает, что вы Доминант.", 6
				);
				addMenuInput(200, "ABDL (0-100):", "rpabdl", "InputRpAbdl",
					"Введите число от 0 до 100, чтобы установить ваш уровень репутации ABDL!", 6
				);
				addMenuInput(200, "Психушка (от -100 до 100):", "rpasyl", "InputRpAsyl",
					"Введите число от -100 до 100, чтобы установить ваш уровень репутации в Психушке! Отрицательное число означает, что вы Пациент, положительное число означает, что вы Медсестра/Медбрат.", 6
				);
				addMenuInput(200, "Азартные игры (0-100):", "rpgamb", "InputRpGamb",
					"Введите число от 0 до 100, чтобы установить ваш уровень репутации в Азартных играх!", 6
				);
				addMenuInput(200, "Игры (0-100):", "rpgame", "InputRpGame",
					"Введите число от 0 до 100, чтобы установить ваш уровень репутации в Играх!", 6
				);
				addMenuInput(200, "Похищение (0-100):", "rpkidn", "InputRpKidn",
					"Введите число от 0 до 100, чтобы установить ваш уровень репутации в Похищениях!", 6
				);
				addMenuInput(200, "LARP (0-100):", "rplarp", "InputRpLarp",
					"Введите число от 0 до 100, чтобы установить ваш уровень репутации в LARP!", 6
				);
				addMenuInput(200, "Дом Магии (0-4):", "rpmagh", "InputRpMagh",
					"Введите число от 0 до 4, чтобы выбрать Дом Магии: 0 = Дом Магии не выбран - 1 = Дом Amplector - 2 = Дом Corporis - 3 = Дом Maiestas - 4 = Дом Vincula. Примечание: при изменении этого параметра UBC также автоматически сбросит репутацию Магической Силы до 0 для всех невыбранных Домов Магии.", 6
				);
				addMenuInput(200, "Магическая Сила (0-100):", "rpmagp", "InputRpMagp",
					"Введите число от 0 до 100, чтобы установить ваш уровень репутации Магической Силы в текущем выбранном Доме Магии!", 6
				);
				addMenuInput(200, "Горничная (0-100):", "rpmaid", "InputRpMaid",
					"Введите число от 0 до 100, чтобы установить ваш уровень репутации Горничной!", 6
				);
			}
            ...
            PreferenceSubscreenUBCSkillsLoad = function() {
				...
				addMenuInput(200, "Бондаж (0-10):", "skbondage", "InputSkillBondage",
					"Введите число от 0 до 10, чтобы установить ваш уровень навыка Бондажа!", 6
				);
				addMenuInput(200, "Выездка (0-10):", "skdressage", "InputSkillDressage",
					"Введите число от 0 до 10, чтобы установить ваш уровень навыка Выездки (Конюшни)!", 6
				);
				addMenuInput(200, "Побег (0-10):", "skevasion", "InputSkillEvasion",
					"Введите число от 0 до 10, чтобы установить ваш уровень навыка Побега!", 6
				);
				addMenuInput(200, "Проникновение (0-10):", "skinfiltration", "InputSkillInfiltration",
					"Введите число от 0 до 10, чтобы установить ваш уровень навыка Проникновения!", 6
				);
				addMenuInput(200, "Взлом замков (0-10):", "sklockpicking", "InputSkillLockpicking",
					"Введите число от 0 до 10, чтобы установить ваш уровень навыка Взлома замков (Lockpicking)!", 6
				);
				addMenuInput(200, "Самобондаж (0-10):", "skselfbondage", "InputSkillSelfbondage",
					"Введите число от 0 до 10, чтобы установить ваш уровень навыка Самобондажа!", 6
				);
				addMenuInput(200, "Сила воли (0-10):", "skwillpower", "InputSkillWillpower",
					"Введите число от 0 до 10, чтобы установить ваш уровень навыка Силы воли!", 6
				);
			}
            ...
            PreferenceSubscreenUBCSpecialModesLoad = function() {
				...
				DOGSsettings();
				let nmsg = "Этот режим отключает кнопки ОСВОБОДИТЬСЯ/ВЫЙТИ и горячие клавиши, а также предотвращает многие команды на себе: boost, leave (BCAR), quit, safeworditem, safewordspecific (BCAR), slowleave, solidity (если значение < 20), totalrelease, unlock, untie. Если этот режим включён, его нельзя отключить, когда вы связаны. Если вы находитесь в режиме total unrestrict при включении этой опции, ныйспециальных режим богини будет автоматически отключён.";
				if (((Player.IsRestrained() == true) || (dogsforbid == true)) && (noescape == true)) {
					addMenuCheckbox(64, 64, 'Включить режим "без побега": ', "noescape", nmsg, true, 150);
				} else {
					addMenuCheckbox(64, 64, 'Включить режим "без побега": ', "noescape", nmsg, false, 150);
				}
				addMenuCheckbox(64, 64, 'Принудительный режим "без побега" с коварными (Devious) замками: ', "dogsforced",
					'Когда режим "без побега" отключён, вы можете решить принудительно включать этот режим, когда на вас коварные (Devious) замки! Разумеется, эти замки должны быть включены в моде DOGS. Обратите внимание, что этот режим останется включённым, когда коварные замки будут сняты: вам нужно отключить его вручную.', "Player.UBC.ubcSettings.noescape", 150
				);
				addMenuCheckbox(64, 64, "Включить тихий режим: ", "silent",
					"Этот режим запрещает использовать команду message, и его основной эффект в том, что эти команды не будут отображать сообщения в чат-комнатах: allcolor, clothes, invisible, lock, naked, pet, randomize, restrain, solidity, totalrelease, underwear, unlock, untie, visible. Чтобы вернуться к стандартным сообщениям и снова получить доступ к команде message, вам нужно будет отключить этот режим.", false, 150
				);
				addMenuCheckbox(64, 64, "Расширить тихий режим на стоп-слово: ", "silsafe",
					"Когда тихий режим включён, вы можете решить также использовать стоп-слово BC без какого-либо сообщения в чате! Разумеется, полезно только если стоп-слово включено!", "!Player.UBC.ubcSettings.silent", 150
				);
				addMenuCheckbox(64, 64, "Включить мягкий режим без ограничений: ", "usoft",
					"Эффекты этого режима (также доступны в режиме total unrestrict): скрытые предметы добавляются в ваш инвентарь, доступ к предметам, скрытым под другими предметами, использование таких предметов, как чемодан, деревянный поднос горничной или коврик (paddle) на себе или других игроках в этом режиме, а также функция осмотра сохраняется, когда вы ослеплены, но не при полной сенсорной депривации. Это не убирает условия для использования ассетов. Вам нужно будет сделать полный перезаход, чтобы покинуть этот режим (если вы снимете галочку, это не возымеет никакого эффекта).", false, 150
				);
				addMenuCheckbox(64, 64, "Включить тотальный режим без ограничений: ", "utotal",
					'Помимо всех эффектов мягкого режима без ограничений, этот режим богини позволяет быть доминантом и сабмиссивом одновременно, даже если вы связаны. Один из его эффектов (симуляция наличия подходящих ключей) может быть заблокирован Uwall и разрешён Ulist. Этот режим недоступен, если вы находитесь в режиме "без побега". Он может вызвать предупреждение BCX. Просто проигнорируйте его (закройте сообщение о нарушении)! Вам нужно будет сделать полный перезаход, чтобы покинуть этот специальный режим (если вы снимете галочку, это не возымеет никакого эффекта).', "Player.UBC.ubcSettings.noescape", 150
				);
			}
            ...
            PreferenceSubscreenUBCTalkingLoad = function() {
				...
				addMenuInput(200, "Время АФК до отправки сообщения (1-60):", "afktime", "InputAFKTime",
					"Введите число от 1 до 60, чтобы установить количество минут АФК (отошли от клавиатуры), после которого в чате будет отображено автоматическое сообщение, информирующее других игроков о вашем статусе АФК. По умолчанию — 10 минут.", 30
				);
				addMenuCheckbox(64, 64, "Включить автоматическое сообщение об АФК: ", "afkinfo",
					"Когда включено, в чате будет отображаться автоматическое сообщение, информирующее других игроков о вашем статусе АФК, когда вы находитесь в этом статусе с момента времени, установленного вами для этой функции. Это также активирует иконку АФК и будет повторяться каждые 30 минут после первого сообщения. Примечание: Когда вы больше не АФК, «принудительная» настройка с иконкой АФК не будет изменена, вам нужно изменить её вручную, если вы этого хотите.", false, 166
				);
				addMenuInput(200, "Режим животной речи/шёпота (0-9):", "animal", "InputAnimalMode",
					"Введите число от 0 до 9, чтобы выбрать один из этих принудительных «постоянных» режимов животной речи или шёпота: 0 Человек - 1 Крольчиха - 2 Корова - 3 Лиса - 4 Кошечка - 5 Мышь - 6 Свинья - 7 Пони - 8 Щенок - 9 Волчонок. Если вы хотите только один раз поговорить в определённом режиме речи, используйте команду /atalk после выбора здесь 0 (человеческая речь).", 30
				);
				addMenuCheckbox(64, 64, "Включить гибридный режим речи/шёпота: ", "ahybrid",
					"Когда включено и связано с режимом животной речи, все ваши сообщения в чате и шёпот будут сочетать животные и человеческие слова!", false, 166
				);
				addMenuCheckbox(64, 64, "Включить режим кукольной речи (и шёпота): ", "dolltalk",
					"Когда включено, максимум 5 слов в сообщении или шёпоте, и вы не можете использовать слова длиннее 6 символов. Соблюдение этих правил проверяется в оригинальной версии вашего сообщения или шёпота, до его изменения заиканием, стонами (Moaner), лепетом, кляп-речью, животной речью.", false, 166
				);
				addMenuInput(200, "Принудительная кляп-речь/шёпот (0-11):", "gaglevel", "InputGagLevel",
					"Введите число от 0 до 11, чтобы выбрать «постоянный» принудительный уровень: 0 Функция отключена - 1 Почти нет кляпа - 2 Очень лёгкий кляп - 3 Лёгкий кляп - 4 Лёгкий кляп (простой) - 5 Обычный кляп - 6 Средний кляп - 7 Тяжёлый кляп - 8 Усиленный тяжёлый кляп - 9 Очень тяжёлый кляп - 10 Полный кляп - 11 Лепет. Если вы действительно в кляпе, ваш выбор может только усилить эффект, но не уменьшить его. Чтобы один раз поговорить с кляп-речью, используйте команду /gtalk. Чтобы поговорить один раз как малыш, используйте /btalk. Смотрите также кнопку РУИР.", 30
				);
				addMenuInput(200, "Принудительный режим слуха (1-6):", "hearing", "InputHearingMode",
					"Введите число от 1 до 6, чтобы выбрать один из этих принудительных «постоянных» режимов слуха, игнорирующих ваше реальное состояние: 1 Нет глухоты - 2 Лёгкая глухота - 3 Обычная глухота - 4 Тяжёлая глухота - 5 Очень тяжёлая глухота - 6 Полная глухота. Обратите внимание, что вам нужно будет сделать полный перезаход, чтобы покинуть этот специальный режим (если вы введёте 0, это не возымеет никакого эффекта). Этот режим может вызвать предупреждение BCX. Просто проигнорируйте его (закройте сообщение о нарушении)!", 30
				);
				addMenuInput(200, "Принудительный уровень заикания (0-4):", "stutterlevel", "InputStutterLevel",
					"Введите число от 0 до 4, чтобы выбрать один из этих принудительных «постоянных» уровней заикания при разговоре или шёпоте: 0 Нет заикания - 1 Лёгкое заикание - 2 Обычное заикание - 3 Тяжёлое заикание - 4 Полное заикание. Обратите внимание, что если на вас вибратор, ваш выбор может только усилить эффект, но не уменьшить его. Если вы хотите только один раз поговорить с определённым уровнем заикания, используйте команду /stalk после выбора здесь 0 (нет заикания).", 30
				);
				let wmsg = "Когда включено, вы не можете использовать обычный шёпот. Возможны только OOC и emotes-шёпот. Эта опция недоступна, когда обнаружено активное аналогичное правило BCX. В этом случае UBC применит ограничения шёпота BCX, но не будет отправлять публичные сообщения или добавлять записи в журнал поведения, если вы попытаетесь шептать, когда это не разрешено.";
				let wbc = 0;
				...
				if (wbc == 0) {
					addMenuCheckbox(64, 64, 'Включить режим "без шёпота": ', "nowhisper", wmsg, false, 166);
				} else {
					addMenuCheckbox(64, 64, 'Включить режим "без шёпота": ', "nowhisper", wmsg, true, 166);
				}
			}
			...
			PreferenceSubscreenUBCVisualLoad = function() {
                ...
                addMenuInput(200, "Управление анимацией предметов (0-2):", "animstate", "InputAnimControl",
                    "Введите число от 0 до 2, чтобы управлять анимацией, встроенной в некоторые предметы, такие как футуристический ящик: 0 Нет управления - 1 Частичное управление (2 обновления в секунду) - 2 Полное управление (без анимации). Важное примечание: изменение анимации предметов может в некоторых случаях привести к неожиданным эффектам, таким как графические проблемы, баги или несоответствия. Используйте это только в том случае, если вы испытываете проблемы с лагами.", 65
                );
                let pmsg = "По умолчанию BC добавляет сообщения и розовый эффект, когда вы очень возбуждены и, вероятно, скоро испытаете оргазм. Если вам это не нравится, эта настройка UBC сделает вас счастливыми! Примечание: Она недоступна, когда обнаружена включённой функция Splatter из LSCG.";
                let spl = 0;
                let LSCG = Player.ExtensionSettings.LSCG;
                if (LSCG) {
                    let LSCGdata = JSON.parse(LZString.decompressFromBase64(LSCG));
                ...
                if (spl == 0) {
                    addMenuCheckbox(64, 64, "Отключить розовый оверлей возбуждения BC: ", "nopinkscr", pmsg, false, 200);
                } else {
                    addMenuCheckbox(64, 64, "Отключить розовый оверлей возбуждения BC: ", "nopinkscr", pmsg, true, 200);
                }
                addMenuCheckbox(64, 64, "Убрать нижнюю панель UBC в Поиске Чата: ", "noubcbar",
					"Если вы отметите эту настройку, UBC не будет отображать нижнюю панель в Поиске Чата. Недостающие опции доступны в меню Поиска Чата.", false, 200
				);
				addMenuInput(200, "Принудительный режим слепоты (1-4):", "blindness", "InputBlindnessMode",
					"Введите число от 1 до 4, чтобы выбрать один из этих принудительных «постоянных» режимов слепоты, игнорирующих ваше реальное состояние: 1 Нет слепоты - 2 Лёгкая слепота - 3 Обычная слепота - 4 Тяжёлая слепота. Обратите внимание, что вам нужно будет сделать полный перезаход, чтобы покинуть этот специальный режим (если вы введёте 0, это не возымеет никакого эффекта). Этот режим может вызвать предупреждение BCX. Просто проигнорируйте его (закройте сообщение о нарушении)!", 65
				);
				addMenuInput(200, "Принудительное размытое зрение (1-5):", "blurmode", "InputBlurMode",
					"Введите число от 1 до 5, чтобы выбрать один из этих принудительных «постоянных» режимов размытого зрения, игнорирующих ваше реальное состояние: 1 Нет размытого зрения - 2 Лёгкое размытое зрение - 3 Обычное размытое зрение - 4 Тяжёлое размытое зрение - 5 Полное размытое зрение. Обратите внимание, что вам нужно будет сделать полный перезаход, чтобы покинуть этот специальный режим (если вы введёте 0, это не возымеет никакого эффекта). Этот режим может вызвать предупреждение BCX. Просто проигнорируйте его (закройте сообщение о нарушении)!", 65
				);
				addMenuCheckbox(64, 64, "Полностью отключить все настройки тонировки UBC: ", "tintnever",
					"Если вы отметите эту настройку, все настройки тонировки UBC (уровень, цвет, MBS) будут полностью отключены. Однако потребуется полный перезаход, чтобы восстановить исходные или тематические цвета на экранах MBS.", false, 200
				);
				addMenuInput(200, "Уровень эффекта тонировки (0-3):", "tintlevel", "InputTintLevel",
					"Введите число от 0 до 3, чтобы выбрать один из этих принудительных «постоянных» уровней эффекта тонировки: 0 Нет эффекта тонировки - 1 Лёгкий эффект тонировки - 2 Средний эффект тонировки - 3 Тяжёлый эффект тонировки.", 65
				);
				addMenuInput(200, "Цвет эффекта тонировки (формат #000000):", "tintcolor", "InputTintColor",
					"Введите код цвета в шестнадцатеричном формате #000000, чтобы применить эффект тонировки почти везде в Bondage Club. Не забудьте также выбрать уровень эффекта тонировки! Эффект тонировки также будет применяться на страницах, созданных большинством аддонов. Известные исключения — BCX и мод Echo. Случай с MBS особый (смотрите конкретную настройку). Итоговый цвет может отличаться при смешивании с тематическим цветом.", 65
				);
				let mbsmsg = "Когда включено, ВСЕГДА заходите на экран Расширений, чтобы активировать это после входа в игру. Цвет тонировки будет использоваться как цвет фона для центральной части экранов MBS. Если вы позже отключите это, восстановленный цвет будет соответствовать цвету MBS по умолчанию или основному тематическому цвету. Эта настройка не имеет никакого эффекта, когда уровень тонировки равен 0. Она недоступна, когда MBS не используется или когда все настройки тонировки UBC полностью отключены.";
				let mbb = 0;
				...
				if (mbb == 0) {
					addMenuCheckbox(64, 64, "Включить эффект тонировки на экранах MBS: ", "tintmbs", mbsmsg, true, 200);
				} else {
					addMenuCheckbox(64, 64, "Включить эффект тонировки на экранах MBS: ", "tintmbs", mbsmsg, "Player.UBC.ubcSettings.tintnever", 200);
				}
            }
    ...
    modApi.hookFunction('AsylumEntranceRun', 4, async (args, next) => {
        TintsEffect();
        DrawText("Чат-комнаты", 130, 530, "White", "Black");
        if (asylumlimit == false) {
            if (IsFemale() == true) DrawButton(240, 475, 90, 90, "", "White", "Screens/Online/ChatSelect/Female.png", "Только женщины");
            if (IsMale() == true) DrawButton(240, 475, 90, 90, "", "White", "Screens/Online/ChatSelect/Male.png", "Только мужчины");
            DrawButton(240, 585, 90, 90, "", "White", "Icons/Gender.png", "Смешанное");
        } 
        DrawButton(350, 475, 90, 90, "", "White", "Icons/Asylum.png", "Психушка");
        return next(args);
    });
    ...
    modApi.hookFunction('ChatAdminRun', 4, async (args, next) => {
        ...
        if (ChatAdminCanEdit()) {
            DrawButton(1230, 450, 60, 60, "", "White", "", "Случайный фон");
	...
	modApi.hookFunction('ChatRoomClick', 4, (args, next) => {
        ...
        if ((sosbuttons == true) && (noescape == false)) {
            if ((MouseX >= 955) && (MouseX < 1000) && (MouseY >= 315) && (MouseY < 360)) {
                let msg = "Магические лазеры заставляют исчезнуть все путы и игрушки на " + tmpname + "'s body.";
        ...
        if ((outbuttons == true) && (noescape == false)) {
            if ((MouseX >= 955) && (MouseX < 1000) && (MouseY >= 360) && (MouseY < 405)) {
                if (slowleave == true) {
                    let msg = "" + tmpname + " медленно направляется к двери.";
                    publicmsg(msg);
                    setTimeout(function() {
                        OutChat();
                    }, 15000);
        ...
        if (posX !== Player.MapData.Pos.X || posY !== Player.MapData.Pos.Y) {
            ...
            if ((item1 == "FloorItem") && (item2 != "Blank")) {
                if ((item2 == "BondageBench") && ((maptrap1 == 1) || (maptrap1 == 9))) {
					BondageBenchTrap();
					let msg = "" + tmpname + " внезапно пойман(а) на Бондажной Скамье.";
					publicmsg(msg);
				}
				if ((item2 == "Coffin") && ((maptrap1 == 2) || (maptrap1 == 9))) {
					CoffinTrap();
					let msg = "" + tmpname + " внезапно пойман(а) в Гробу";
					publicmsg(msg);
				}
				if ((item2 == "TheDisplayFrame") && ((maptrap1 == 3) || (maptrap1 == 9))) {
					DisplayFrameTrap();
					let msg = "" + tmpname + " внезапно пойман(а) в Демонстрационной Раме.";
					publicmsg(msg);
				}
				if ((item2 == "Kennel") && ((maptrap1 == 4) || (maptrap1 == 9))) {
					KennelTrap();
					let msg = "" + tmpname + " внезапно пойман(а) в Конуре.";
					publicmsg(msg);
				}
				if ((item2 == "Locker") && ((maptrap1 == 5) || (maptrap1 == 9))) {
					LockerTrap();
					let msg = "" + tmpname + " внезапно пойман(а) в Шкафчике.";
					publicmsg(msg);
				}
				if ((item2 == "Trolley") && ((maptrap1 == 6) || (maptrap1 == 9))) {
					TrolleyTrap();
					let msg = "" + tmpname + " внезапно пойман(а) на Тележке.";
					publicmsg(msg);
				}
				if ((item2 == "WoodenBox") && ((maptrap1 == 7) || (maptrap1 == 9))) {
					WoodenBoxTrap();
					let msg = "" + tmpname + " внезапно пойман(а) в Деревянном Ящике.";
					publicmsg(msg);
				}
				if ((item2 == "X-Cross") && ((maptrap1 == 8) || (maptrap1 == 9))) {
					XCrossTrap();
					let msg = "" + tmpname + " внезапно пойман(а) на X-Кресте.";
					publicmsg(msg);
				}
            }
        }
    ...
    modApi.hookFunction('ChatRoomMapViewTeleportHiddenMessage', 4, (args, next) => {
        if (noteleport) {
            ...
            if (bltp == 1) {
                let msg = "Телепортация не разрешена.";
                publicmsg(msg);
                return;
            }
        }
            ...
            if (tsp == 0) {
                if (dolltalk == true) {
                    ...
                    if (nm == 1) {
                        ...
                        let msg = "Сообщение или шёпот не может быть отправлено, поскольку не соответствует правилам речи кукол.";
                        infomsg(msg);
                    }
                }
                if ((nowhisper == true) || (wh1 == 1)) {
                    ...
                    if (nw == 1) {
                        text2 = "";
                        ElementValue("InputChat", "");
                        let msg = 'Шёпот не может быть отправлен, поскольку вы находитесь в режиме "без шёпота".';
                        if (wh1 == 1) msg = "Шёпот не может быть отправлен, поскольку правило BCX запрещает вам шептаться с выбранным игроком.";
                        infomsg(msg);
                    }
                }
            }
	...
	async function ULTRAChatRoomTopMenuSync() {
        modApi.hookFunction('ChatRoomTopMenuSync', 4, (args, next) => {
            ...
            if (rglbuttons == true) DrawButton(955, 405, 45, 45, "РУИР", "White", "", "");
    ...
    async function ULTRAClubCardBuilderRun() {
        modApi.hookFunction('ClubCardBuilderRun', 4, (args, next) => {
            TintsEffect();
            if (ClubCardBuilderDeckIndex == -1) {
                DrawButton(1425, 25, 90, 90, "", "White", "Icons/Reset.png", "Стандартный фон");
                DrawButton(1540, 25, 90, 90, "", "White", "Icons/Random.png", "Случайный фон");
            }
            next(args);
        });
    }
    ...
    modApi.hookFunction('LoginRun', 4, (args, next) => {
        DrawButton(750, 145, 500, 60, "ULTRAbc " + UBCver + " Загружен!", "Pink", "", "");
        return next(args);
    });
    ...
    modApi.hookFunction('MainHallRun', 4, async (args, next) => {
        ...
        if (IsFemale() == true) DrawButton(240, 475, 90, 90, "", "White", "Screens/Online/ChatSelect/Female.png", "Только женщины");
        if (IsMale() == true) DrawButton(240, 475, 90, 90, "", "White", "Screens/Online/ChatSelect/Male.png", "Только мужчины");
        if (asylumlimit == false) DrawButton(350, 475, 90, 90, "", "White", "Icons/Asylum.png", "Психушка");
        DrawButton(460, 475, 90, 90, "", "White", "Icons/Gender.png", "Смешанное");
        DrawButton(570, 475, 90, 90, "", "White", "Icons/Reset.png", "Фон по умолчанию");
        DrawText("ULTRAbc", 130, 615, "White", "Black");
        DrawText(UBCver, 140, 655, "White", "Black");
        DrawButton(240, 585, 200, 90, "", "White", "", "Открыть журнал изменений UBC на GitHub");
        DrawImageResize("Icons/Changelog.png", 240, 600, 60, 60);
        DrawTextFit("Изменения", 365, 633, 308, "Black");
        DrawButton(460, 585, 90, 90, "", "White", "Icons/Preference.png", "Настройки");
        DrawButton(570, 585, 90, 90, "", "White", "Icons/Random.png", "Случайный фон");
        DrawButton(460, 695, 90, 90, "", "White", "Icons/Extensions.png", "Расширения");
        DrawButton(570, 695, 90, 90, "", "White", "Icons/Explore.png", "Выбрать фон");
        DrawText("/uhelp", 145, 725, "White", "Black");
        DrawText("в чат", 140, 765, "White", "Black");
        DrawButton(240, 695, 200, 90, "", "White", "", "Открыть UBC Вики на GitHub");
        DrawImageResize("Icons/Introduction.png", 250, 710, 60, 60);
        DrawTextFit("Вики", 375, 743, 308, "Black");
        return next(args);
    });
    ...
    modApi.patchFunction(
        "PreferenceSubscreenChatLoad", {
            ...
            "let List1 = PreferenceSubscreenChatCheckboxes; if (Player.UBC.ubcSettings.alfaprf == true) List1 = Player.UBC.ubcSettings.ListChat1; const checkboxElements = List1.map((checkbox) => {",   
        }
    );
    ...
    modApi.hookFunction("PreferenceSubscreenOnlineLoad", 4, async (args, next) => {
        ...
        if (ifext == true) PreferenceBackground = ifname;
        setTimeout(() => {
            const grid = document.getElementById(PreferenceSubscreenOnlineIDs.grid);
            if (grid && Player.UBC?.ubcSettings?.alfaprf === true) {
                const lastChild = grid.lastElementChild;
                if (lastChild) {
                    grid.insertBefore(lastChild, grid.firstChild);
                }
            }
        }, 0);
        return next(args);
    ...
    modApi.hookFunction('PreferenceSubscreenOnlineRun', 4, async (args, next) => {
        if (PreferencePageCurrent === 2) {
            ...
            DrawButton(1160, 330, 60, 60, "", "White", "", "Уютное Шале");
            DrawButton(1260, 330, 60, 60, "", "White", "", "Случайный фон");
   ...
   modApi.patchFunction(
        "PrivateClick", {
            ...
            'let backgrounds = BackgroundsPrivateRoomTagList; if (Player.UBC.ubcSettings.bgall) backgrounds = BackgroundsTagList; if (MouseIn(1885, PrivateButtonTop(7), 90, 90) && LogQuery("RentRoom", "PrivateRoom")) {',
    ...
    modApi.hookFunction('PrivateRun', 4, async (args, next) => {
        if (LogQuery("RentRoom", "PrivateRoom")) {
            DrawButton(0, 900, 49, 49, "", "White", "", "Случайный фон");
            DrawButton(0, 950, 49, 49, "", "White", "", "Фон по умолчанию");
    ...
    modApi.hookFunction('CellRun', 4, async (args, next) => {
        ...
        if (outbuttons == true) OutButtons();
        if (notcbuttons == false) {
            DrawButton(1765, 745, 90, 90, "", "White", "Icons/Reset.png", "Фон по умолчанию");
            DrawButton(1885, 745, 90, 90, "", "White", "Icons/Random.png", "Случайный фон");
            DrawButton(1885, 865, 90, 90, "", "White", "Icons/Explore.png", "Выбрать фон");
        }
        TintsEffect();
        return next(args);
    });
    ...
    function OutButtons() {
        ...
        if (noescape == false) {
            if (window.CurrentScreen == "ChatRoom") {
                DrawButton(955, 360, 45, 45, "ВЫХОД", "White", "", "");
            } else {
                if (slowleave == true) {
                    DrawButton(0, 90, 45, 45, "ВЫХОД", "White", "", "Медленный выход");
                } else {
                    DrawButton(0, 90, 45, 45, "ВЫХОД", "White", "", "Быстрый выход");
                }
            }
        }
    }
    ...
    function SosButtons() {
        ...
        if (noescape == false) {
            if (window.CurrentScreen == "ChatRoom") {
                DrawButton(955, 315, 45, 45, "Освободиться", "White", "", "");
            } else {
                DrawButton(0, 45, 45, 45, "Освободиться", "White", "", "Полное освобождение");
            }
        }
    }
    ...
    function ChatSearchCreateSearchControls() {
        ...
        const searchInput = ElementCreateSearchInput(
            ...
            () => {
                ...
                search: {
                    classList: ["chat-search-input-search-box"]
                }
            },
        );
        ...
        ChatSearchSearchMenu = ElementCreate({
            ...
            children: [
                ...
                // Full rooms
                {
                    ...
                    classList: ["chat-search-search-menu-grid-item"],
                    children: [
                        ElementCreateSettingsLabel(TextGet("ShowFullRooms"), "chat-search-search-menu-full-rooms-input", {
                            position: "left"
                        }),
                ...
                // Locked rooms
                {
                    ...
                    classList: ["chat-search-search-menu-grid-item"],
                    children: [
                        ElementCreateSettingsLabel(TextGet("ShowLockedRooms"), "chat-search-search-menu-locked-rooms-input", {
                            position: "left"
                        }),
                ...
                // Search description
                {
                    ...
                    classList: ["chat-search-search-menu-grid-item"],
                    children: [
                        ElementCreateSettingsLabel(TextGet("SearchDescription"), "chat-search-search-menu-search-description-input", {
                            position: "left"
                        }),
                ...
                // Friends
                {
                    ...
                    classList: ["chat-search-search-menu-grid-item"],
                    children: [
                        ElementCreateSettingsLabel("Сначала комнаты с друзьями", "chat-search-search-menu-search-friends-input", {
                            position: "left"
                        }),
                ...
                // AutoJoin feature
                {
                    ...
                    classList: ["chat-search-search-menu-grid-item"],
                    children: [
                        ElementCreateSettingsLabel("Функция Автовхода:", "chat-search-search-menu-search-autojoin-input", {
                            position: "left"
                        }),
                ...
                // Language
                {
                    ...
                    classList: ["chat-search-search-menu-grid-item"],
                    children: [
                        ElementCreateSettingsLabel("Язык", "chat-search-search-menu-room-language-dropdown"),
                        ElementCreateDropdown(
                ...
                // Room size
                {
                    ...
                    classList: ["chat-search-search-menu-grid-item"],
                    children: [
                        ElementCreateSettingsLabel("Размер комнаты", "chat-search-search-menu-room-size-grid"),
                        {
                            tag: "div",
                            attributes: {
                ...
                // Players in room
                {
                    ...
                    classList: ["chat-search-search-menu-grid-item"],
                    children: [
                        ElementCreateSettingsLabel("Игроков в комнате", "chat-search-search-menu-players-grid"),
                        {
                            tag: "div",
                            attributes: {
    ...
    function applySleepEffect(character, name, pronoun2) {
        publicmsg(
            character === Player ?
            `${tmpname} глотает снотворное и выпивает стакан воды. ${pronoun1} засыпает очень быстро.` :
            `${tmpname} заставляет ${name} проглотить снотворное и выпить стакан воды. ${name} засыпает очень быстро.`
        );
    ...
    function InformationSheetDrawButtons(C) {
        ...
        if (C.IsPlayer()) {
            ...
            if (noifbuttons == false) {
                DrawButton(1575, 910, 90, 90, "", "White", "Icons/Reset.png", "Фон по умолчанию");
                DrawButton(1695, 910, 90, 90, "", "White", "Icons/Random.png", "Случайный фон");
                DrawButton(1815, 910, 90, 90, "", "White", "Icons/Explore.png", "Выбрать фон");
            }
        } else if (C.IsOnline()) {
		...
		if (C.OnlineSharedSettings != undefined) {
            if (C.OnlineSharedSettings.cowner1 != undefined) {
                if (C.OnlineSharedSettings.cowner1 != "") {
                    DrawTextFit("Ошейник надет " + C.OnlineSharedSettings.cowner1 + " (" + C.OnlineSharedSettings.cowner2 + ")", 550, currentY, 450, "Black", "Gray");
                    currentY += spacing;
                    DrawTextFit("на " + C.OnlineSharedSettings.cowner3 + " дней", 550, currentY, 450, "Black", "Gray");
                    const y = currentY;
                    currentY += spacing;
                    return currentY;
                    return;
    ...
    function keysinfo(Player) {
        ...
        ChatRoomSendLocal(`Ключи найдены: ${keys.join(" - ") || "Нет"}.`);
    }
    ...
    function UBCinfo(character, command) {
        ...
        let ubc1 = "Не использует ULTRAbc.";
        let ubc2 = "Не использует Uwall.";
        const shared = character.OnlineSharedSettings || {};
        if (shared.UBC === UBCver || shared.UBC === UBCver0) {
            ubc1 = "является пользователем ULTRAbc.";
            if (shared.Unoescape === true) {
                ubc1 = 'UBC в режиме "без побега"';
            }
        }
        if (typeof shared.Uwall === "boolean") {
            ubc2 = shared.Uwall ? "включил(а) Uwall." : "выключил(а) Uwall.";
        }
    ...
    function RealGarblingLevel() {
        ...
        if (nbl == 1) {
            ...
            if (window.CurrentScreen == "ChatRoom") {
                let msg = "Включён режим настоящего детского лепета.";
            ...
            if (mgl == 0) {
                ...
                M_MOANER_saveControls();
                if (window.CurrentScreen == "ChatRoom") {
                    let msg = "Включён обычный режим речи.";
                    if (ntt == 1) msg = msg + " " + umsg8;
                    infomsg(msg);
                }
            } else {
                ...
                M_MOANER_saveControls();
                if (window.CurrentScreen == "ChatRoom") {
                    let msg = "Включён режим настоящей кляп-речи. Ваш текущий уровень искажения " + ngl + ".";
                    if (ntt == 1) msg = msg + " " + umsg8;
                    infomsg(msg);
                }
            }
    ...
    function getPronoun1(target) {
        ...
        tgpr1 = "Они";
        if (name == "HeHim") tgpr1 = "Он";
        if (name == "SheHer") tgpr1 = "Она";
        if (name == "ItIt") tgpr1 = "Оно";
        return tgpr1;
    }
    ...
    function getPronoun2(target) {
        let name = InventoryGet(target, "Pronouns").Asset.Name;
        tgpr2 = "их";
        if (name == "HeHim") tgpr2 = "его";
        if (name == "SheHer") tgpr2 = "её";
        if (name == "ItIt") tgpr2 = "его";
        return tgpr2;
    }
    ...
    function getPronoun3(target) {
        let name = InventoryGet(target, "Pronouns").Asset.Name;
        tgpr3 = "их";
        if (name == "HeHim") tgpr3 = "его";
        if (name == "SheHer") tgpr3 = "её";
        if (name == "ItIt") tgpr3 = "его";
        return tgpr3;
    }
    ...
    function getPronoun4(target) {
        let name = InventoryGet(target, "Pronouns").Asset.Name;
        tgpr4 = "Они";
        if (name == "HeHim") tgpr4 = "он";
        if (name == "SheHer") tgpr4 = "она";
        if (name == "ItIt") tgpr4 = "оно";
        return tgpr4;
    }
    ...
    async function WheelGame(option) {
        ...
        WheelStart = function() {
            ...
            if (option == "i") {
                WheelFortuneExit();
                let msg = "Опции на этом колесе от 0 до " + maxwh + ".";
                infomsg(msg);
            }
            if (option == "r") {
                WheelFortuneRoleplay = false;
                ...
                if ((id != "j") && (id != "k") && (id != "l") && (id != "m")) {
                    Result.push(Roll - 1);
                    let msg = tmpname + " случайно выбирает опцию на колесе" + tgpname;
                    publicmsg(msg);
                    WheelFortuneValue = WheelFortuneOption.map(o => o.ID)[Result];
                    WheelFortuneResult();
                } else {
                    WheelFortuneExit();
                    let msg = "Без результата! Попробуйте ещё раз!";
                    infomsg(msg);
                }
            }
        }
    ...
    function showM_MOANER_scriptStatus() {
        let msg = "Стоны (Moaner) не активированы.";
        if (M_MOANER_scriptOn) msg = "Стоны (Moaner) активированы.";
        statusmsg(msg);
    }

    function showM_MOANER_profileStatus() {
        let msg = "Настоящий профиль стонов (Moaner): " + profileName;
        if (profileName == "default") msg = "Нет кастомного профиля стонов (Moaner).";
        statusmsg(msg);
    }

    function showM_MOANER_orgasmStatus() {
        let msg = "Стоны при оргазме не включены.";
        if (M_MOANER_orgasmActive) msg = "Стоны при оргазме включены.";
        statusmsg(msg);
    }

    function showM_MOANER_spankStatus() {
        let msg = "Стоны при шлепках не включены.";
        if (M_MOANER_spankActive) msg = "Стоны при шлепках включены.";
        statusmsg(msg);
    }

    function showM_MOANER_talkStatus() {
        let msg = "Стоны при разговоре не включены. Если вы находитесь под вибрацией, вы не будете стонать.";
        if (M_MOANER_talkActive) msg = "Стоны при разговоре включены. Если вы находитесь под вибрацией, вы будете стонать.";
        statusmsg(msg);
    }

    function showM_MOANER_whisperStatus() {
        let msg = "Стоны при шёпоте не включены. Если вы находитесь под вибрацией, вы не будете стонать при шёпоте.";
        if (M_MOANER_whisperActive) msg = "Стоны при шёпоте включены. Если вы находитесь под вибрацией, вы будете стонать при шёпоте.";
        statusmsg(msg);
    }

    function showM_MOANER_tickleStatus() {
        let msg = "Стоны при шекотке не включены.";
        if (M_MOANER_tickleActive) msg = "Стоны при шекотке включены.";
        statusmsg(msg);
    }

    function showM_MOANER_vibratorStatus() {
        let msg = "Стоны при изменении режима вибрации не включены.";
        if (M_MOANER_vibratorActive) msg = "Стоны при изменении режима вибрации включены.";
        statusmsg(msg);
    }

    function showM_MOANER_xvibratorStatus() {
        let msg = "Стоны xvibes не включены. Если настройки вибраторов других игроков изменятся, вы не будете стонать.";
        if (M_MOANER_xvibratorActive) msg = "Стоны xvibes включены. Если настройки вибраторов других игроков изменятся, вы будете стонать.";
        statusmsg(msg);
    }
    ...
    CommandCombine([{
        ...
        Action: (args) => {
            args = (args || "").trim();
            if (!args) {
                let msg = "Команда allcolor должна сопровождаться кодом цвета, числом, соответствующим категории, и опционально целью.\n" + " \n" + "Код цвета должен быть в шестнадцатеричном формате: #RRGGBB или #RGB.\n" + " \n" + "Числа для категорий: 1 = Предметы - 2 = Одежда (исключая косплей) - 3 = Косплей - 4 = Тело - 5 = Все категории.";
                infomsg(msg);
                return;
            }
            ...
            if (!isValidColor) {
                infomsg("Неверный цвет. Используйте шестнадцатеричный формат, например #RRGGBB или #RGB.");
                return;
            }
            if (!category || isNaN(category) || category < 1 || category > 5) {
                infomsg("Неверная категория. Используйте число от 1 до 5, для категории, которую вы хотите покрасить: 1 = Предметы - 2 = Одежда (включая косплей) - 3 = Косплей - 4 = Тело - 5 = Все категории.");
                return;
            }
            let catname = "";
            if (category == 1) catname = "предметах.";
            if (category == 2) catname = "одежде.";
            if (category == 3) catname = "косплее.";
            if (category == 4) catname = "теле.";
            if (category == 5) catname = "предметах, одежде, косплее и теле.";
    ...
    CommandCombine([{
        Tag: 'asylum',
        Description: "(минуты): вход в психушку, условия могут быть не соблюдены.",
        Action: (args) => {
            if ((args === "") && (ReputationGet(Player, "Asylum") < 0)) {
                let msg = "Вы должны указать минуты, если вы пациент.";
                infomsg(msg);
            } else {
    ...
    CommandCombine([{
        ...
        Action: (_, command, args) => {
            let help = 'Команда atalk должна сопровождаться числом от 1 до 9 для животного и словами, которые вы хотите сказать.\n" + "Обратите внимание, что её нельзя использовать, когда вы находитесь в "постоянном" режиме животной речи.\n" + "Доступные животные:\n" + "1 крольчиха - 2 корова - 3 лиса - 4 кошечка - 5 мышь\n" + "6 свинья - 7 пони - 8 щенок - 9 волчонок';
            let [mode] = args;
            ...
            if (!msg) {
                infomsg("Пожалуйста, укажите слова для произнесения после номера животного.");
                return;
            }
    ...
    CommandCombine([{
        Tag: 'autoheart',
        Description: "(уровень вибрации) (режим оргазма) (время): надевает на вас сердечные замки и настраивает их.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда autoheart должна сопровождаться 3 числами для уровня вибрации, режима оргазма и времени замка.\n" + "Обратите внимание, что сердечный замок требует специальный мод.\n" + " \n" + "Доступные уровни вибрации:\n" + "0 = Выкл - 1 = Низкий - 2 = Средний - 3 = Высокий \n" + "Доступные режимы оргазма:\n" + "0 = Обычный - 1 = На грани - 2 = Запрет\n" + "Время указывается в часах. Минимум 1 час. Используйте 0 для неограниченного времени.\n" + "Используйте ? если хотите, чтобы время было выбрано игрой случайно (от 1 до 720 часов).";
                infomsg(msg);
            } else {
                ...
                if (heart != 0) {
                    infomsg("Сердечные замки применены и настроены.");
                    ChatRoomCharacterUpdate(Player);
                    let data = JSON.parse(JSON.stringify(Player.HeartLock));
                    ServerSend('ChatRoomChat', {
                        Type: 'Hidden',
                        Content: 'HeartLockSync',
                        Dictionary: [{
                            Tag: 'HeartLockData',
                            Data: data
                        }],
    ...
    CommandCombine([{
        Tag: 'autokick',
        Description: ": включает АвтоКик аккаунтов, которые были созданы 0 дней назад..",
        Action: () => {
            if (this.AutoKickOn == false || this.AutoKickOn == undefined) {
                let msg = "АвтоКик готов.";
                infomsg(msg);
                AutoKickOn = true;
                AutoKicker = function(data, days = 1, hours = 12, minutes = 0) {
                    ...
                    if (data.Content == "ServerEnter" && character.Creation > CurrentTime - days - hours - minutes) {
                        ...
                        let msg = "АвтоКик: Аккаунт был создан 0 дней назад.";
                        publicmsg(msg);
                    };
                };
    ...
    CommandCombine([{
        Tag: 'bg1',
        Description: '(число): использует фоны "Bondage College" или "Bondage Teacher" как фоны по умолчанию.',
        Action: (args) => {
            ...
            if (args === "") {
                let msg = "Команда bg1 должна сопровождаться числом. Список доступных фонов:\n" + "BONDAGE COLLEGE\n" + "1 Художественный класс - 2, 3 Класс - 4 Клуб - 5 Колледж\n" + "6 Общежитие - 7 Раздевалка - 8 Спортзал\n" + "9 до 12 Изолятор - 13 до 16 Кинбаку-клуб\n" + "17 до 26 Библиотека - 27, 28 Шкафчики\n" + "29 Беговая дорожка - 30, 31 Душевые - 32 Театр\n" + "BONDAGE TEACHER\n" + "33, 34 Пляж - 35, 36 Портфель - 37 Мишень\n" + "38, 39 Класс - 40 Колледж - 41 Офис";
                infomsg(msg);
            } else {
                let bg = "";
    ...
    CommandCombine([{
        Tag: 'bg2',
        Description: '(число): использует фон "Bondage Brawl" в качестве фона по умолчанию.',
        Action: (args) => {
            if (args === "") {
                let msg = "Команда bg2 должна сопровождаться числом. Список фонов Bondage Brawl:\n" + "1, 2 Балкон - 3 Бальный зал - 4 до 12 Лагерь бандитов\n" + "13 до 15 Амбар - 16 до 18 Ванная Оливии\n" + "19 Спальня-темница - 20 Спальня Эдварда\n" + "21, 22 Спальня Изабеллы - 23 Спальня Мелоди\n" + "24 до 26 Спальня Оливии - 27 до 32 Берёзы\n" + "33 Чёрный - 34 до 36 Лагерь\n" + "37 до 39 Замок - 40, 41 Поляна\n" + "42 до 44 Колледж - 45 до 47 Зал графини\n" + "48 Пустыня - 49, 50 Темница - 51, 52 Тюремная камера\n" + "53 до 55 Хранилище темницы - 56 Лес\n" + "57 до 60 Лесная хижина - 61 Газ - 62 Зелёная равнина\n" + "63 до 73 Зал (1-4) - 74 до 79 Озеро - 80 Кровать горничной\n" + "81 Горная тропа - 82, 83 Дуб\n" + "84 до 88 Равнина - 89 Пруд - 90, 91 Саванна\n" + "92 до 94 Палатка - 95, 96 Терраса\n" + "97 Равнина грифов - 98, 99 Винный погреб";
                infomsg(msg);
            } else {
                let bg = "";
    ...
    CommandCombine([{
        Tag: 'bglist',
        Description: ": отображает все доступные фоны",
        Action: () => {
    ...
    CommandCombine([{
        Tag: 'bgshow1',
        Description: "(номер фона): отображает локально кликабельную ссылку на определённый стандартный фон и встроенное изображение.",
        Action: (args) => {
            let BCver = GameVersion;
            if (BCver.includes("Beta")) {
                let beta1 = BCver.slice(0, 4);
            ...
            if (args === "") {
                let msg = "Команда bgshow1 должна сопровождаться числом (используйте /bglist для получения списка доступных фонов).";
                infomsg(msg);
            } else {
    ...
    CommandCombine([{
        Tag: 'bgshow2',
        Description: "(номер фона): отправляет в чат ссылку на определённый стандартный фон. При использовании с функцией WCE ссылка становится кликабельной, и изображение может быть встроено в чат.",
        Action: (args) => {
            let BCver = GameVersion;
            if (BCver.includes("Beta")) {
                let beta1 = BCver.slice(0, 4);
            ...
            if (args === "") {
                let msg = "Команда bgshow2 должна сопровождаться числом (используйте /bglist для получения списка доступных фонов)";
                infomsg(msg);
            } else {
                if ((args > -1) && (args < BackgroundsList.length)) {
                    let name = BackgroundsList[args].Name;
    ...
    CommandCombine([{
        Tag: 'bio',
        Description: "(цель): открывает описание профиля любого игрока в чат-комнате.",
        Action: (args) => {
            let target = "";
            if (args === "") {
                CharacterBio(Player);
    ...
    CommandCombine([{
        Tag: 'boost',
        Description: ": увеличивает уровень всех ваших навыков на час.",
        Action: () => {
            if (noescape) {
                let msg = umsg1 + umsg3;
                infomsg(msg);
                ...
                let msg = "Вы чувствуете, что уровни всех ваших навыков увеличились. Изменения можно увидеть в панели информации.";
                infomsg(msg);
            }
        }
    }])
    ...
    CommandCombine([{
        Tag: 'btalk',
        Description: "(текст): отправляет сообщение детским лепетом.",
        Action: (args) => {
            if (!args) {
                infomsg("Команда btalk должна сопровождаться текстом, который вы хотите написать.");
                return;
            }
            if (dolltalk === true && !IsDollTalk(args)) {
                infomsg("Ваше сообщение не может быть отправлено, поскольку оно противоречит правилам общения кукол");
                return;
            }
    ...
    CommandCombine([{
        Tag: 'callubc',
        Description: ": открывает меню UBC (может быть использовано, если в списке расширений нет UBC).",
        Action: () => {
            let msg = "Посмотрите список расширений!";
            infomsg(msg);
            runUBC();
        }
    }])
    ...
    CommandCombine([{
        Tag: 'cgame',
        Description: "(зона): запускает игру в Клубные Карты с определённым NPC.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда cgame должна включать зону.\n" + "Доступные зоны:\n" + "asylum (психушка), cafe (кафе), infiltration (проникновение), introduction (вступление), kidnap (похищение), larp,\n" + "lounge (лаунж), magic (магия), movie (кино), shibari (шибари), stable (конюшня).\n" + "Вам нужно нажать на соответствующего NPC, затем выбрать подходящую опцию.\n" + "Для магии опция карт появится после долгого диалога, выйдите и вернитесь, если вы начали квест, запрошенный кицунэ, но ещё не завершили его.";
                infomsg(msg);
            } else {
                minigame = args;
                M_MOANER_saveControls();
    ...
    CommandCombine([{
        Tag: 'chess',
        Description: "(сложность): запускает шахматы.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда chess должна сопровождаться числом от 1 до 3.\n" + " \n" + "Доступные режимы сложности:\n" + "1 лёгкий\n" + "2 обычный\n" + "3 сложный\n" + "Обратите внимание, что после окончания шахматной партии требуется полный перезаход.";
                infomsg(msg);
            } else {
    ...
    CommandCombine([{
        Tag: 'clothes',
        Description: "(цель): случайно изменяет одежду.",
        Action: (args) => {
            let target = Player;
            if (args != "") target = TargetSearch(args);
            if (!target) return;
            if (target == Player) {
                let msg = "Магические лазеры надевают случайную одежду на тело " + tmpname + ".";
                ...
                if ((target.AllowItem == true) && (target.OnlineSharedSettings.UBC != undefined)) {
                    ...
                    if (IsTargetProtected(target)) {
                        ...
                        let msg = "Магические лазеры надевают случайную одежду на тело " + tgpname + ".";
    ...
    CommandCombine([{
        Tag: 'cname',
        Description: "(пользовательское имя): создаёт пользовательское имя.",
        Action: (args, originalInput) => {
            if (args === "") {
                let msg = "Команда cname должна сопровождаться пользовательским именем, которое вы хотите отображать в профиле.\n" + "Допускается больше символов, чем для официального имени, могут быть пробелы и цифры.\n" + "Максимум 20 символов (включая пробелы)!\n" + "Работает только между пользователями UBC и заменяет официальное имя в профиле.\n" + "Используйте None в качестве имени, чтобы вернуться к профилю без пользовательского имени.";
                infomsg(msg);
                return;
            }
            ...
            if ((length > 0) && (length < 21) && (custom.match(LS))) {
                if (custom === "None") {
                    cname = "";
                    infomsg("Пользовательское имя удалено");
                } else {
                    cname = custom;
                    infomsg("Пользовательское имя создано или модифицировано");
                }
                M_MOANER_saveControls();
                Player.OnlineSharedSettings.cname = cname;
                ServerAccountUpdate.QueueData({
                ...
                infomsg("20 символов – (включая пробелы)!");
            }
        }
    }])
    ...
    CommandCombine([{
        Tag: 'college',
        Description: ": вход в колледж, обходит требования.",
        Action: () => {
            ChatRoomSetLastChatRoom("");
            ServerSend("ChatRoomLeave", "");
            OnlineGameName = "";
    ...
    CommandCombine([{
        Tag: 'colorchanger',
        Description: "(анимация): выдаёт анимацию со сменой цвета.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда colorchanger:\n" + "Для предварительного выбора есть два варианта, введите: <b>/colorchanger hair</b> или <b>/colorchanger eyes</b>\n" + "Для ручного выбора области введите: <b>/colorchanger set</b> или <b>/colorchanger select</b> или <b>/colorchanger custom</b>\n" + "Ручной выбор может одновременно выбирать только 10 областей,\n" + "затем требует сброса для повторного использования, введите: <b>/colorchanger stop</b> или <b>/colorchanger reset</b>\n" + "Одновременно может быть активна только 1 цель";
                infomsg(msg);
            }
            if ((args === "custom") || (args === "set") || (args === "select")) {
                let msg = "У вас есть 5 секунд, чтобы нажать на цель и выбрать область. В случае успеха будет возвращено. Если нет — попробуйте снова";
                infomsg(msg);
                setTimeout(function() {
	...
	CommandCombine([{
        Tag: 'cowner',
        Description: "(id члена клуба) (количество дней во владении) (имя владельца): устанавливает пользовательское имя владельца, видимое в вашем профиле.",
        Action: (args, originalInput) => {
            args = (args || "").trim();
            originalInput = originalInput || "";
            if (args === "") {
                let msg = "Команда cowner должна сопровождаться номером участника желаемого владельца, количеством дней владения и именем пользовательского владельца.\n" + "Этот пользовательский владелец может быть любым игроком, даже вы сами или саб, которым вы владеете.\n" + "Количество дней владения не может превышать количество дней вашего пребывания в игре.\n" + "Максимум 20 символов для имени (включая пробелы)!\n" + "Работает только между пользователями UBC и заменяет официальную информацию в профиле.\n" + "Используйте None в качестве имени, чтобы вернуться к профилю без пользовательского владельца.";
                infomsg(msg);
                return;
            }
            ...
            if (m) {
                ...
                const parts = args.split(/\s+/);
                if (parts.length < 3) {
                    infomsg("Использование: cowner <номер_участника> <дни> <имя> (имя может содержать пробелы). Используйте 'None' для удаления пользовательского владельца.");
                    return;
                }
            ...
            if (!Number.isInteger(number) || number <= 0) {
                infomsg("Неверный номер участника. Должно быть положительное целое число.");
                return;
            }
            ...
            if (days > gameDaysNumber) {
                infomsg("Количество дней владения не может превышать количество дней вашего пребывания в игре (" + gameDaysNumber + ").");
                return;
            }
            const allowedNameRe = /^[\p{L}\p{N}\p{Zs}'-]+$/u;
            if (!nameRaw || nameRaw.length === 0) {
                infomsg('Имя не может быть пустым. Используйте "None" для удаления пользовательского владельца.');
                return;
            }
            if (nameRaw.length > 20) {
                infomsg("Максимум 20 символов (включая пробелы)!");
                return;
            }
            ...
            if (!nameIsValid) {
                infomsg("Имя содержит недопустимые символы. Разрешены: буквы, цифры, пробелы, апостроф (') и дефис (-).");
                return;
            }
            if (nameRaw === "None") {
                cowner1 = "";
                cowner2 = 0;
                cowner3 = 0;
                infomsg("Пользовательский владелец удалён");
            } else {
                cowner1 = nameRaw;
                cowner2 = number;
                cowner3 = days;
                infomsg("Пользовательский владелец создан или изменён");
            }
            M_MOANER_saveControls();
            Player.OnlineSharedSettings.cowner1 = cowner1;
            Player.OnlineSharedSettings.cowner2 = cowner2;
    ...
    CommandCombine([{
        Tag: 'ctitle',
        Description: "(титул): устанавливает пользовательский титул.",
        Action: (args, originalInput) => {
            if (args === "") {
                let msg = "Команда ctitle должна сопровождаться пользовательским титулом, который вы хотите отображать в профиле.\n" + "Это может быть оригинальный титул или существующий официальный титул, для которого вы не удовлетворяете некоторым условиям.\n" + "Максимум 25 символов (включая пробелы)!\n" + "Работает только между пользователями UBC.\n" + "Этот титул не будет отображаться на экране Титулов.\n" + "Используйте None в качестве титула, чтобы вернуться к профилю без пользовательского титула.";
                infomsg(msg);
                return;
            }
            ...
            if ((length > 0) && (length < 26) && (custom.match(LS))) {
                if (custom === "None") {
                    ctitle = "";
                    infomsg("Пользовательский титул удалён");
                } else {
                    ctitle = custom;
                    infomsg("Пользовательский титул создан или изменён");
                }
                M_MOANER_saveControls();
                Player.OnlineSharedSettings.ctitle = ctitle;
                ServerAccountUpdate.QueueData({
                ...
                infomsg("Максимум 25 символов (включая пробелы)!");
            }
        }
    }])
    ...
    CommandCombine([{
        Tag: 'difficulty',
        Description: "(число): изменяет режим сложности.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда difficulty должна сопровождаться числом от 0 до 3.\n" + " \n" + "Доступные режимы сложности:\n" + "0 ролевая игра\n" + "1 обычная\n" + "2 хардкор\n" + "3 экстрим";
                infomsg(msg);
            } else {
    ...
    CommandCombine([{
        Tag: 'font',
        Description: "(шрифт) (размер): изменяет шрифт BC. ",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда font должна сопровождаться номером шрифта и опционально номером размера.\n" + "Поддерживаемые шрифты: 0 Arial - 1 Times New Roman\n" + "2 Papyrus - 3 Comic Sans - 4 Impact\n" + "5 Helvetica Neue - 6 Verdana - 7 Century Gothic\n" + "8 Georgia - 9 Courrier New - 10 Copperplate\n" + "Размеры: 0 Маленький - 1 Средний - 2 Большой";
                infomsg(msg);
            } else {
    ...
    CommandCombine([{
        Tag: 'frlist',
        Description: "(лобби): даёт доступ к списку друзей в текущем лобби.",
        Action: () => {
            RoomToGame();
            CommonSetScreen("Online", "ChatSearch");
            FriendListReturn = {
    ...
    CommandCombine([{
        Tag: 'game',
        Description: "(мини-игра): начинает мини-игру.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда game должна включать мини-игру.\n" + "Доступные мини-игры:\n" + "carrot (морковь), cleaning (уборка), dojo (додзё), drinks (напитки), hurdle (барьер), kidnap (похищение), movie1 (фильм1),\n" + "movie2 (фильм2), puppy (щенок), rhythm (ритм), tennis1, tennis2, tennis3,\n" + "training (тренировка), whippony (хлыст пони).\n" + "Tennis1 = лёгкий, tennis2 = обычный, tennis3 = сложный\n" + "Training — это версия игры с барьером с тренером.\n" + "Обычно вам нужно нажать на NPC и выбрать соответствующие опции в диалогах.";
                infomsg(msg);
            } else {
                minigame = args;
                M_MOANER_saveControls();
    ...
    CommandCombine([{
        Tag: 'ggts',
        Description: "(минуты) (уровень):  начинает тренировку GGTS в Психушке.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда ggts должна сопровождаться двумя числами для указания минут и уровня (1-6).";
                infomsg(msg);
            } else {
                ...
                minigame = level;
                M_MOANER_saveControls();
                let msg = "" + tmpname + " схвачен(а) двумя горничными и заперт(а) в психушке на " + minutes + " минут тренировки с Системой Тренировки Хорошей Девочки Уровня " + level + ".";
                publicmsg(msg);
    ...
    CommandCombine([{
        Tag: 'gtalk',
        Description: "(режим) (текст): отправляет сообщение при кляп-речи.",
        Action: (_, command, args) => {
            let help = "Команда gtalk должна сопровождаться числом от 0 до 10, затем словами, которые вы хотите сказать.\n" + " \n" + "Доступные режимы речи:\n" + "0 настоящая кляп-речь (на основе надетых кляпов и других предметов, ограничивающих речь)\n" + "1 почти нет кляп-речи\n" + "2 очень лёгкая кляп-речь\n" + "3 лёгкая кляп-речь\n" + "4 простая кляп-речь\n" + "5 обычная кляп-речь\n" + "6 средняя кляп-речь\n" + "7 тяжёлая кляп-речь\n" + "8 усиленная тяжёлая кляп-речь\n" + "9 очень тяжёлая кляп-речь\n" + "10 полная кляп-речь";
            let [gaglevel] = args;
            ...
            let msg = message?.join(" ");
            if (!msg) {
                infomsg("Пожалуйста, укажите слова после уровня кляп-речи.");
                return;
            }
            if (dolltalk === true && IsDollTalk(msg) === false) {
                infomsg(umsg4);
    ...
    CommandCombine([{
        Tag: 'hint',
        Description: "(цель) (подсказка): добавляет или изменяет подсказки к паролям у таймеров-замков.",
        Action: (_, command, args) => {
            let [targetname] = args;
            if (!targetname) {
                let msg = "Команда hint должна сопровождаться целью и подсказкой, которую вы хотите добавить к замкам с паролем.";
                infomsg(msg);
            } else {
                let [, , ...message] = command.split(" ");
    ...
    CommandCombine([{
        Tag: 'horny',
        Description: "(число): напрямую устанавливает уровень возбуждения.",
        Action: (args) => {
            let msg1 = "Команда horny должна сопровождаться числом от 0 до 100.";
            let msg2 = "Ваш уровень возбуждения был изменён.";
    ...
    CommandCombine([{
        Tag: 'infolock',
        Description: ": даёт информацию (код, пароль, оставшееся время) замка на надетом ограничении в выбранном слоте.",
        Action: () => {
            if (extrainfo == false) {
                let msg = "Вы  не можете использовать эту команду согласно вашим настройкам.";
                infomsg(msg);
            } else {
                let msg = "У вас есть 5 секунд, чтобы нажать на себя или другого игрока. В случае успеха вы получите информацию о замке для выбранного слота.";
                infomsg(msg);
                setTimeout(function() {
                    if (CurrentCharacter != null) {
                        let Target = "";
                                ...
                                if (Inventory.Property.Name != null) {
                                    ...
                                    if (Inventory.Property.Name == "DeviousPadlock") {
                                        ...
                                        if (DOGSdata.deviousPadlock.itemGroups[Target].unlockTime != undefined) {
                                            Lock = "Devious Padlock";
                                            asset = Inventory.Asset.Description;
                                            time = DOGSdata.deviousPadlock.itemGroups[Target].unlockTime;
                                            time = new Date(time);
                                            left = TimerToString(time - CurrentTime);
                                            ChatRoomSendLocal("AssetGroup = " + Target);
                                            ChatRoomSendLocal("Заперто с помощью " + Lock);
                                            ChatRoomSendLocal("" + asset + " = " + left + "");
                                        }
                                    }
                                }
    ...
    CommandCombine([{
        Tag: 'invisible',
        Description: "(цель): заставляет цель стать полностью прозрачной (использование скриптов в настройках BC должно быть разрешено).",
        Action: (args) => {
            let target = Player;
            if (args != "") target = TargetSearch(args);
            if (!target) return;
            if (target == Player) {
                if (Player.OnlineSharedSettings.ScriptPermissions.Hide.permission == 0) {
                    let msg = "Чтобы использовать команду invisible на себе, сначала разрешите Скрипты в настройках BC.";
                    infomsg(msg);
                    return;
                }
                let msg = "Магические лазеры делают " + tmpname + " полностью невидимым(ой).";
                ...
                if ((target.AllowItem == true) && (target.OnlineSharedSettings.UBC != undefined)) {
                    ...
                    if (target.OnlineSharedSettings.ScriptPermissions.Hide.permission == 0) {
                        let msg = "Чтобы использовать команду invisible на других игроках, они сначала должны разрешить Скрипты в настройках BC.";
                        infomsg(msg);
                        return;
                    }
                    if (IsTargetProtected(target)) {
                        ...
                        let msg = "Магические лазеры делают " + tgpname + " полностью невидимым(ой).";
    ...
    CommandCombine([{
        Tag: 'itemcolor',
        Description: "(цветовой код): изменяет цвет ограничения в выбранном слоте.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда itemcolor должна сопровождаться кодом цвета в формате #000000 для изменения цвета надетого предмета в слоте, выбранном кликом мыши.";
                infomsg(msg);
            } else {
                let color = args;
                if (color.startsWith("#")) {
                    let msg = "У вас есть 5 секунд, чтобы нажать на себя. В случае успеха цвет надетого предмета в выбранном слоте будет изменён. Если нет — попробуйте снова.";
                    infomsg(msg);
                    setTimeout(function() {
    ...
    CommandCombine([{
        Tag: 'keydeposit',
        Description: "(часы): оставляет ваши ключи в ключевом депозите.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда keydeposit должна сопровождаться числом больше 0.";
                infomsg(msg);
            } else {
                let hours = args;
                if (hours > 0) {
                    let msg = "Ключи " + tmpname + " теперь в безопасности в хранилище на " + hours + " часов.";
                    publicmsg(msg);
    ...
    CommandCombine([{
        Tag: 'killpar',
        Description: ": сбрасывает параметры стонов (Moaner), сохранённых локально.",
        Action: (args) => {
            if (args === "") {
                let msg = "<b>Предупреждение</b>: Эта команда удалит все локально сохранённые параметры UBC/Moaner. Используйте её только если некоторые параметры не работают. Подтвердите, введя: <b>/killpar yes</b>";
                infomsg(msg);
            } else if (args === "yes") {
                M_MOANER_deleteControls();
                let msg = "Все параметры UBC/Moaner удалены. Сделайте полный выход/вход, затем используйте соответствующие команды для установки нужных параметров.";
                infomsg(msg);
            }
        }
    }])
    ...
    CommandCombine([{
        Tag: 'layerset',
        Description: "(число слоя) (код цвета) изменяет цвет слоя ограничения в выбранном слоте",
        Action: (args) => {
            if (args === "") {
                let msg = "Сначала используйте команду <b>/layershow</b>, чтобы нажать на надетый предмет, получить полезную информацию о цветах слоёв и сохранить Слот Предмета.\n" + "Команда layerset должна сопровождаться номером слоя (-1 для всех слоёв) и кодом цвета в формате #000000 для надетого предмета в ранее сохранённом Слоте Предмета.\n" + "Если вы введёте нечисловой слой, он будет интерпретирован как 0 (ноль). Если введённый цвет не существует, вы вернётесь к цвету по умолчанию.";
                infomsg(msg);
            } else {
                let stringLys1 = args;
                ...
                if (this.saveditemslot == undefined) {
                    let msg = "<b>Предупреждение</b>: Сначала используйте команду <b>/layershow</b>, чтобы получить полезную информацию и сохранить Слот Предмета.";
                    infomsg(msg);
                } else {
                    ...
                    if ((InventoryGet(Player, Target) != null) && (color.startsWith("#"))) {
                        ...
                        ChatRoomCharacterUpdate(Player);
                        let msg = "Цвет слоя изменён для слоя " + layer + ".";
                        if (layer == -1) msg = "Цвет слоя изменён для всех слоёв.";
                        infomsg(msg);
                    }
                }
            }
    ...
    CommandCombine([{
        Tag: 'layershow',
        Description: ": даёт информацию о цветах слоёв определённого надетого предмета + сохраняет Слот Предмета",
        Action: () => {
            let msg = "У вас есть 5 секунд, чтобы нажать на себя. В случае успеха вы получите информацию и Слот Предмета будет сохранён. Если нет — попробуйте снова.";
            infomsg(msg);
            setTimeout(function() {
                if ((CurrentCharacter != null) && (CurrentCharacter == Player)) {
                    let Target = "";
                    if (CurrentCharacter.FocusGroup.Name) {
                        ...
                        if (InventoryGet(Player, Target) != null) {
                            ...
                            if (ak < 2) {
                                ...
                                while (ly < Asset.Layer.length) {
                                    ...
                                    if (InventoryGet(Player, Target).Asset.Layer[ly].AllowColorize) {
                                        ...
                                        Color2 = "Нет возможности изменить цвет";
                                    }
                            ...
                            let msg = "Слот Предмета сохранён.";
                            infomsg(msg);
                        }
                        DialogLeave();
                    }
    ...
    CommandCombine([{
        Tag: 'lock',
        Description: "(цель) (тип замка) (другие параметры): добавляет замки ко всем ограничениям.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда lock имеет несколько синтаксисов:\n" +
						"/lock (цель) (тип замка) для замков 1-8, 17, 19-22\n" +
						"/lock (цель) (тип замка) (r) для замка 9\n" +
						"/lock (цель) (тип замка) (код) для замка 10\n" +
						"/lock (цель) (тип замка) (пароль) (r) для замков 11 и 12\n" +
						"/lock (цель) (тип _замка) (минуты) (h) (i) (r) - замки 13-15, 18\n" +
						"/lock (цель) (тип замка) (пароль) (минуты) (h) (i) (r) - замок 16\n" +
						"ВСЕГДА УКАЗЫВАЙТЕ ЦЕЛЬ. Типы замков:\n" +
						"1 Металлический (по умолчанию) - 2 Эксклюзивный\n" +
						"3 Сложный - 4 Высокая безопасность - 5 Пандора\n" +
						"6 Хозяйка - 7 Любовник - 8 Владелец - 9 Пять минут\n" +
						"10 Комбинация - 11 Стоп-слово - 12 Пароль\n" +
						"13 Таймер Хозяйки - 14 Таймер Любовника - 15 Таймер Владельца\n" +
						"16 Таймер-пароль - 17 Лучший друг - 18 Таймер ЛД\n" +
						"19 Семья - 20 Непристойный герб - 21 Коварный (если включён)\n" +
						"22 Сердечный (если включён)\n" +
						"Замки 17, 18, 20, 21 и 22 требуют специальный мод\n" +
						"Используйте <b>/lock par</b> для информации о других параметрах"
                infomsg(msg);
            } else if (args === "par") {
                let msg = "Специальные параметры команды lock:\n" +
						"код должен быть от 0 до 9999.\n" +
						"пароль ограничен 8 символами.\n" +
						"максимальное время = 240 минут для замков 13 и 16,\n" +
						"10080 минут для замков 14 и 18,\n" +
						"50400 минут для замка 15\n" +
						"Используйте ? если хотите, чтобы время было выбрано игрой случайно\n" +
						" \n" +
						"Дополнительные параметры:\n" +
						"h чтобы скрыть таймер,\n" +
						"i чтобы включить ввод времени другими игроками,\n" +
						"r для удаления предмета при вводе правильного пароля\n" +
						"или по истечении таймера замка.\n" +
						" \n" +
						"Совет: замените h и/или i другим символом, если нужно их пропустить."
                infomsg(msg);
            } else {
                let code = 0;
                let dogs = 1;
                ...
                if ((target != null) && ((target == Player) || (target.AllowItem == true)) && (target.OnlineSharedSettings.UBC != undefined)) {
                    ...
                    if (dogs == 0) {
                        if (tmpname == tgpname) {
                            let msg = "Магические лазеры создают замки на теле " + tgpname + ".";
    ...
    CommandCombine([{
        Tag: 'login',
        Description: "(имя аккаунта) (пароль): вход в другой аккаунт.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда login должна сопровождаться именем аккаунта и паролем";
                infomsg(msg);
            } else {
    ...
    CommandCombine([{
        Tag: 'mapfog',
        Description: ": переключает туман в текущей комнате с картой.",
        Action: () => {
            ...
            infomsg(`Туман в текущей комнате с картой ${status === "enabled" ? "включён" : "выключен"}. Нет видимого эффекта, если вы включили полное зрение в комнатах с картой.`);
        }
    }])

    CommandCombine([{
        Tag: 'mapforce',
        Description: ": принудительно включает доступ к карте в текущей обычной комнате (только для вас).",
        Action: () => {
    ...
    CommandCombine([{
        Tag: 'mapkeys',
        Description: "(число) (действие): выдаёт или забирает все ключи либо конкретный ключ.",
        Action: (args) => {
            if (!IsMapRoom()) return infomsg(umsg5);
            if (!args) {
                return infomsg(
                    "Команда mapkeys должна сопровождаться двумя числами.\n" + "1-е число: 1 = Бронзовый ключ - 2 = Серебряный ключ - 3 = Золотой ключ - 4 = Все ключи.\n" + "2-е число: 1 = Найти - 2 = Потерять."
                );
            }
            if (!Player.MapData) return infomsg("Вы не вошли на карту.");
            ...
            const foundKeys = keys
                ...
                .map(key => key.name);
            ChatRoomSendLocal(`Найденные ключи: ${foundKeys.join(" - ") || "Нет"}.`);
            ChatRoomSendLocal(" ");
        }
    }])
    ...
    CommandCombine([{
        Tag: 'maproom',
        Description: ": даёт информацию о локации всех игроков на карте.",
        Action: () => {
            ...
            ChatRoomCharacter.forEach(character => {
                ...
                if (MapData) {
                    ...
                    if (ChatRoomData.MapData.Type === "Always") {
                        exinfo = "Реальное присутствие на карте: ДА";
                    } else if (ChatRoomData.MapData.Type === "Hybrid") {
                        if (typeof OnlineSharedSettings.Inmap === "boolean") {
                            exinfo = `Реальное присутствие на карте: ${OnlineSharedSettings.Inmap ? "ДА" : "НЕТ"}`;
                        } else {
                            exinfo = "Реальное присутствие на карте: ?";
                        }
                    }
                    const {
                        X,
                    ...
                    ChatRoomSendLocal("Вы не вошли на карту");
                }
                ChatRoomSendLocal(" ");
            });
        }
    ...
    CommandCombine([{
        Tag: 'mapx',
        Description: "(x-позиция): изменяет позицию игрока по горизонтале.",
        Action: (args) => {
            const plx = Number(args);
            if (args === "" || isNaN(plx) || plx < 0 || plx > 39) {
                infomsg("Команда mapx должна сопровождаться числом от 0 до 39.");
                return;
            }
            if (!IsMapRoom()) return infomsg(umsg5);
            if (!Player.MapData) return infomsg("Вы не вошли на карту!");
    ...
    CommandCombine([{
        Tag: 'mapy',
        Description: "(y-позиция): изменяет позицию игрока по вертикале.",
        Action: (args) => {
            const ply = Number(args);
            if (args === "" || isNaN(ply) || ply < 0 || ply > 39) {
                infomsg("Команда mapy должна сопровождаться числом от 0 до 39.");
                return;
            }
            if (!IsMapRoom()) return infomsg(umsg5);
            if (!Player.MapData) return infomsg("Вы не вошли на карту!");
    ...
    CommandCombine([{
        Tag: 'mapz',
        Description: "(цель): выдаёт координаты цели на карте.",
        Action: (args) => {
            if (!IsMapRoom()) return infomsg(umsg5);
    ...
    CommandCombine([{
        Tag: 'mapzoom',
        Description: "(value): изменяет зум (приближение).",
        Action: (args) => {
            const plz = Number(args);
            if (args === "" || isNaN(plz) || plz < 7 || plz > 50) {
                infomsg("Команда mapzoom должна сопровождаться числом от 7 до 50.");
                return;
            }
            if (!IsMapRoom()) return infomsg(umsg5);
            ChatRoomMapViewPerceptionRangeMax = plz;
            infomsg("Уровень зума изменён! Наслаждайтесь!");
        }
    }])

    CommandCombine([{
        Tag: 'maxstatistics',
        Description: ": выдаёт максимальную статистику.",
        Action: () => {
            ...
            let msg = "Изменения внесены! Несколько других вещей должны быть установлены с помощью команд /roleplay и /rolequit.";
            infomsg(msg);
        }
    }])
    ...
    CommandCombine([{
        Tag: 'mbsroom',
        Description: ": выдаёт информацию о MBS колесе удачи у других игроков.",
        Action: () => {
            ChatRoomCharacter.forEach(character => {
                const {
                    Nickname,
                ...
                if (!InventoryAvailable(character, "WheelFortune", "ItemDevices")) {
                    ChatRoomSendLocal("Не имеет колеса фортуны.");
                    ChatRoomSendLocal(" ");
                    return;
                }
                ...
                if (!MBS) {
                    ChatRoomSendLocal("Не имеет MBS колеса фортуны.");
                    ChatRoomSendLocal(" ");
                    return;
                }
                ChatRoomSendLocal("Имеет MBS колеса фортуны.");
                if (MBS.Version !== undefined) {
                    ChatRoomSendLocal("Не имеет пользовательских опций на этом колесе.");
                    ChatRoomSendLocal(" ");
                    return;
                }
                let decompressed;
                ...
                try {
                    ...
                    ChatRoomSendLocal("Ошибка при чтении пользовательский опций.");
                    ChatRoomSendLocal(" ");
                    return;
                }
                let found = false;
    ...
    CommandCombine([{
        Tag: 'message',
        Description: "(опция) (сообщение): отправляет изменённое сообщение при выполнении какого-либо действия.",
        Action: (_, command, args) => {
            if (silent) {
                let msg = umsg1 + umsg7;
                infomsg(msg);
            ...
            var [option] = args;
            if (!option) {
                let msg = "Команда message должна сопровождаться опцией и сообщением, которое вы хотите использовать вместо стандартного.\n" +
						"Каждая опция соответствует команде, префикс 't' добавляется для использования на других игроках.\n" +
						"Опции на себе: clothes, invisible, lock, naked, pet, randomize, restrain, solidity, totalrelease, underwear, unlock, untie, visible\n" +
						"Опции на других игроках: tclothes, tinvisible, tlock, tnaked, tpet, trandomize, trestrain, tsolidity, ttotalrelease, tunderwear, tunlock, tuntie, tvisible\n" +
						" \n" +
						"При написании сообщения не забывайте, что ваше имя или ник будет добавлено перед ним\n" +
						"При действии на другого игрока имя или ник цели будет добавлено после сообщения\n" +
						"Используйте ? в качестве сообщения, чтобы вернуться к стандартному сообщению\n" +
						"Используйте ! в качестве сообщения, чтобы выбрать тихий режим (без сообщения)";
                infomsg(msg);
                return;
            }
            let [, , ...message] = command.split(" ");
            ...
            if (custom != "") {
                ...
                let msg1 = "<p style='background-color:#5fbd7a'>ULTRAbc: Тихий режим сохранён для команды " + option + " на себе.</p>";
                let msg2 = "<p style='background-color:#5fbd7a'>ULTRAbc: Возврат к стандартному сообщению для команды " + option + " на себе.</p>"
				let msg3 = "<p style='background-color:#5fbd7a'>ULTRAbc: Новое сообщение сохранено для команды " + option + " на себе.</p>"
				let msg4 = "<p style='background-color:#5fbd7a'>ULTRAbc: Тихий режим сохранён для команды " + option2 + " на других игроках.</p>";
				let msg5 = "<p style='background-color:#5fbd7a'>ULTRAbc: Возврат к стандартному сообщению для команды " + option2 + " на других игроках.</p>";
				let msg6 = "<p style='background-color:#5fbd7a'>ULTRAbc: Новое сообщение сохранено для команды " + option2 + " на других игроках.</p>";
                if (option == "allcolor") {
                    Allcolor = custom;
    ...
    CommandCombine([{
        Tag: 'mission',
        Description: "(миссия): переходит в комнату проникновения и принудительно запускает определённую миссию.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда mission должна включать миссию.\n" +
						"Доступные миссии:\n" +
						"burglar (грабитель), kidnap (похищение), rescue (спасение), retrieve (извлечение), sabotage (саботаж).\n" +
						"Полностью случайная миссия с random.";
                infomsg(msg);
            } else {
                mission = args;
    ...
    CommandCombine([{
        Tag: 'mstatus',
        Description: ": отображает текущий статус Стонов (Moaner).",
        Action: () => {
            showStatus();
        }
    }])
    ...
    CommandCombine([{
        Tag: 'murmur',
        Description: "(НомерУчастника|Имя|Ник)(Сообщение): отправляет шёпот игроку.",
        Action: (args, command) => {
    ...
    CommandCombine([{
        Tag: 'naked',
        Description: "(цель): снимает одежду.",
        Action: (args) => {
            let target = Player;
            if (args != "") target = TargetSearch(args);
            if (!target) return;
            if (target == Player) {
                let msg = "Магические лазеры заставляют исчезнуть одежду на теле " + tmpname + ".";
    ...
    CommandCombine([{
        Tag: 'npcprison',
        Description: "(минуты): остаётся в NPC-тюрьме Пандоры.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда npcprison должна сопровождаться числом больше 0";
                infomsg(msg);
            } else {
                let minutes = args;
                if (minutes > 0) {
                    let msg = "" + tmpname + " схвачен(а) двумя горничными и отправлен(а) в NPC-тюрьму Пандоры на " + minutes + " минут.";
                    publicmsg(msg);
                    DialogLentLockpicks = false;
                    RoomToGame();
    ...
    CommandCombine([{
        Tag: 'outfit',
        Description: "(параметр): восстанавливает/сохраняет/загружает наряд (включая путы).",
        Action: (args) => {
            if (args === "") {
                let msg = "Опции команды outfit:\n" +
						"<b>Все эти опции включают путы</b>, так что это также хороший инструмент для бондажа.\n" +
						"Чтобы восстановить наряд до того, как вы вошли в комнату, введите: <b>/outfit reset</b> или <b>/outfit restore</b> или <b>/outfit revert</b>\n" +
						"Три наряда можно сохранить с помощью <b>/outfit save1</b> или <b>/outfit save2</b> или <b>/outfit save3</b>\n" +
						"Чтобы загрузить сохранённые наряды, введите: <b>/outfit load1</b> или <b>/outfit load2</b> или <b>/outfit load3</b>\n" +
						"У вас будет 5 секунд, чтобы нажать на цель. Повторите, если сохранение/загрузка не удались\n" +
						"Эти сохранения действуют только в течение 1 сеанса входа.\n" +
						"Чтобы сохранить наряды между сеансами, используйте <b>кнопку Экспорта</b> в гардеробе\n" +
						"Наряд будет сохранён в виде кода. Вы можете скопировать и вставить его в другое место.\n" +
						"Затем вы можете использовать <b>кнопки Импорта</b>, чтобы загрузить его позже."
                infomsg(msg);
            }
            if ((args === "load1") || (args === "load2") || (args === "load3")) {
                let msg = "У вас есть 5 секунд, чтобы нажать на цель. В случае успеха наряд будет загружен. Если нет — повторите.";
                infomsg(msg);
                setTimeout(function() {
                    if (CurrentCharacter != null) {
                        if (CurrentCharacter.OnlineSharedSettings.UBC != undefined) {
                            ...
                            if (nl == 1) {
                                DialogLeave();
                                let msg = "Команда " + args + " не выполнена, так как не найдено ни одного сохранённого наряда.";
                                infomsg(msg);
                            }
                            if (nl == 0) {
                                ...
                                if (uw == 0) {
                                    ...
                                    DialogLeave();
                                    let msg = "Команда " + args + " выполнена.";
                                    infomsg(msg);
                                }
                            }
                        }
            ...
            if ((args === "reset") || (args === "revert") || (args === "restore")) {
                ...
                CharacterRefresh(Player);
                ChatRoomCharacterUpdate(Player);
                let msg = "Команда outfit reset-restore-revert выполнена.";
                infomsg(msg);
            }
            if ((args === "save1") || (args === "save2") || (args === "save3")) {
                let msg = "У вас есть 5 секунд, чтобы нажать на цель. В случае успеха наряд будет сохранён. Если нет — повторите.";
                infomsg(msg);
                setTimeout(function() {
                    if (CurrentCharacter != null) {
                        if (CurrentCharacter.OnlineSharedSettings.UBC != undefined) {
    ...
    CommandCombine([{
        Tag: 'permission',
        Description: "(число): изменяет ваше разрешение на предметы.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда permission должна сопровождаться числом.\n" +
						"Эффект будет виден в вашем профиле.\n" +
						"0 Все, без исключений\n" +
						"1 Все, кроме чёрного списка\n" +
						"2 Владелец, Любовник, белый список и Доминанты\n" +
						"3 Только Владелец, Любовник и белый список\n" +
						"4 Только Владелец и Любовник\n" +
						"5 Только Владелец"
                infomsg(msg);
            } else {
                let perm = args * 1;
    ...
    CommandCombine([{
        Tag: 'pet',
        Description: "(цель): становится полностью связанным питомцем.",
        Action: (args) => {
            let target = Player;
            if (args != "") target = TargetSearch(args);
            if (!target) return;
            if (target == Player) {
                let msg = "" + tmpname + " становится милым питомцем.";
    ...
    CommandCombine([{
        Tag: 'ping',
        Description: "(Номер Участника)(Сообщение): отправляет сигнал игроку.",
        Action: (args) => {
    ...
    CommandCombine([{
        Tag: 'pmenu',
        Description: ": прямой доступ к меню Настроек.",
        Action: () => {
            PrfClick();
        }
    }])
    ...
    CommandCombine([{
        Tag: 'poof',
        Description: "(действие): очень быстро покидает клуб.",
        Action: (args) => {
            let message = "";
            if (args === "") {
                message = " исчезает."
    ...
    CommandCombine([{
        Tag: 'pose2',
        Description: "(поза) (цель): изменяет позу любого игрока.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда pose2 должна сопровождаться позой и опционально целью.\n" +
						" \n" +
						"Доступные позы:\n" +
						...
						"tapedhands. Только на себе: exercise, jump.\n" +
						"Используйте <b>/pose2 reset</b> (цель) для возврата к нейтральной позе.\n" +
						"Если WCE включён, используйте <b>/pose baseupper</b> только на себе, когда /pose2 reset не срабатывает."
                infomsg(msg);
            } else {
                ...
                if (targetname == null) {
                    if ((pose == "armsfree") &&
                        ...
                        ChatRoomCharacterUpdate(Player);
                        let msg = "" + tmpname + " расслабляет " + pronoun3 + " руки.";
                        publicmsg(msg);
                    } else if ((pose == "belly") &&
                        ...
                        ChatRoomCharacterUpdate(Player);
                        let msg = "" + tmpname + " расслабляется на " + pronoun3 + " животе.";
                        publicmsg(msg);
                        ...
                        ChatRoomCharacterUpdate(Player);
                        let msg = "" + tmpname + " заводит " + pronoun3 + " руки за спину.";
                        publicmsg(msg);
                    } else if ((pose == "cuffed") &&
                        ...
                        ChatRoomCharacterUpdate(Player);
                        let msg = "" + tmpname + " вытягивает " + pronoun3 + " руки, как будто " + pronoun4 + " в наручниках.";
                        publicmsg(msg);
                        ...
                        ChatRoomCharacterUpdate(Player);
                        let msg = "" + tmpname + " заводит " + pronoun3 + " руки за спину, локти почти соприкасаются.";
                        publicmsg(msg);
                    } else if ((pose == "kneel1") &&
                        ...
                        ChatRoomCharacterUpdate(Player);
                        let msg = "" + tmpname + " встаёт на колени.";
                        publicmsg(msg);
                    } else if ((pose == "kneel2") &&
                        ...
                        ChatRoomCharacterUpdate(Player);
                        let msg = "" + tmpname + " встаёт на колени и разводит " + pronoun3 + " ноги.";
                        publicmsg(msg);
                        ...
                        ChatRoomCharacterUpdate(Player);
                        let msg = "" + tmpname + " встаёт и смыкает " + pronoun3 + " ноги.";
                        publicmsg(msg);
                        ...
                        ChatRoomCharacterUpdate(Player);
                        let msg = "" + tmpname + " встаёт на " + pronoun3 + " ступни.";
                        publicmsg(msg);
                    } else if ((pose == "pet") &&
                        ...
                        ChatRoomCharacterUpdate(Player);
                        let msg = "" + tmpname + " встаёт на четвереньки.";
                        publicmsg(msg);
                        ...
                        ChatRoomCharacterUpdate(Player);
                        let msg = "" + tmpname + " поднимает " + pronoun3 + " руки.";
                        publicmsg(msg);
                        ...
                        ChatRoomCharacterUpdate(Player);
                        let msg = "" + tmpname + " поднимает руки над " + pronoun3 + " головой.";
                        publicmsg(msg);
                        ...
                        ChatRoomCharacterUpdate(Player);
                        let msg = "" + tmpname + " поднимает " + pronoun3 + " руки и разводит " + pronoun3 + " ноги.";
                        publicmsg(msg);
                        ...
                        PoseSetActive(Player, "Spread")
                        ChatRoomCharacterUpdate(Player);
                        let msg = "" + tmpname + " поднимает руки над " + pronoun3 + " головой и разводит " + pronoun3 + " ноги.";
                        publicmsg(msg);
                        ...
                        PoseSetActive(Player, "Spread");
                        ChatRoomCharacterUpdate(Player);
                        let msg = "" + tmpname + " разводит " + pronoun3 + " ноги.";
                        publicmsg(msg);
                    } else if ((pose == "stand") &&
                        ...
                        ChatRoomCharacterUpdate(Player);
                        let msg = "" + tmpname + " теперь в акробатической позе в подвесе.";
                        publicmsg(msg);
                        ...
                        ChatRoomCharacterUpdate(Player);
                        let msg = "" + tmpname + " вытягивает " + pronoun3 + " руки, как будто " + pronoun3 + " руки связаны скотчем.";
                        publicmsg(msg);
                        // Special poses
                    } else if (pose == "jump") {
                        let msg = "" + tmpname + " прыгает от радости.";
                        publicmsg(msg);
                        ...
                        if (InventoryGet(Player, "ItemButt") == null) {
                            ...
                            msg1 = "Вы слишком сильно связаны для тренировки.";
                            infomsg(msg1);
                        }
                        if (msg1 == "") {
                        ...
                        if (IsTargetProtected(target)) {
                            ...
                            if (pose == "armsfree") {
                                if ((target.ActivePose != 'BaseUpper') &&
                                    ...
                                    ChatRoomCharacterUpdate(target);
                                    let msg = "" + tmpname + " позволяет " + tgpname + " расслабить " + tgpr3 + " руки.";
                                    publicmsg(msg);
                                }
                            } else if (pose == "belly") {
                                if ((target.ActivePose != 'Hogtied') &&
                                    ...
                                    ChatRoomCharacterUpdate(target);
                                    let msg = "" + tmpname + " заставляет " + tgpname + " лежать на " + tgpr3 + " животе.";
                                    publicmsg(msg);
                                }
                            } else if (pose == "boxtied") {
                                if ((target.ActivePose != 'BackBoxTie') &&
                                    ...
                                    ChatRoomCharacterUpdate(target);
                                    let msg = "" + tmpname + " заставляет " + tgpname + " завести руки за " + tgpr3 + " спину.";
                                    publicmsg(msg);
                                }
                            } else if (pose == "cuffed") {
                                if ((target.ActivePose != 'BackCuffs') &&
                                    ...
                                    ChatRoomCharacterUpdate(target);
                                    let msg = "" + tmpname + " заставляет " + tgpname + " вытянуть руки, как будто " + tgpr4 + " в наручниках.";
                                    publicmsg(msg);
                                }
                            } else if (pose == "elbowtied") {
                                if ((target.ActivePose != 'BackElbowTouch') &&
                                    ...
                                    ChatRoomCharacterUpdate(target);
                                    let msg = "" + tmpname + " заставляет " + tgpname + " завести руки за спину, локти почти соприкасаются.";
                                    publicmsg(msg);
                                }
                            } else if (pose == "kneel1") {
                                if ((target.ActivePose != 'Kneel') &&
                                    ...
                                    ChatRoomCharacterUpdate(target);
                                    let msg = "" + tmpname + " помогает " + tgpname + " встать на колени.";
                                    publicmsg(msg);
                                }
                            } else if (pose == "kneel2") {
                                if ((target.ActivePose != 'KneelingSpread') &&
                                    ...
                                    ChatRoomCharacterUpdate(target);
                                    let msg = "" + tmpname + " помогает " + tgpname + " встать на колени, заставляя " + tgpr3 + " ноги развестись.";
                                    publicmsg(msg);
                                }
                            } else if (pose == "legsclosed") {
                                if ((target.ActivePose != 'LegsClosed') &&
                                    ...
                                    ChatRoomCharacterUpdate(target);
                                    let msg = "" + tmpname + " помогает " + tgpname + " встать с " + tgpr3 + " сомкнутыми ногами.";
                                    publicmsg(msg);
                                }
                            } else if (pose == "legsopen") {
                                if ((target.ActivePose != 'BaseLower') &&
                                    ...
                                    ChatRoomCharacterUpdate(target);
                                    let msg = "" + tmpname + " помогает " + tgpname + " встать нормально на " + tgpr3 + " ступни.";
                                    publicmsg(msg);
                                }
                            } else if (pose == "pet") {
                                if ((target.ActivePose != 'AllFours') &&
                                    ...
                                    ChatRoomCharacterUpdate(target);
                                    let msg = "" + tmpname + " заставляет " + tgpname + " встать на четвереньки.";
                                    publicmsg(msg);
                                }
                            } else if (pose == "spreadarms1") {
                                if ((target.ActivePose != 'Yoked') &&
                                    ...
                                    ChatRoomCharacterUpdate(target);
                                    let msg = "" + tmpname + " помогает " + tgpname + " поднять " + tgpr3 + " руки.";
                                    publicmsg(msg);
                                }
                            } else if (pose == "spreadarms2") {
                                if ((target.ActivePose != 'OverTheHead') &&
                                    ...
                                    ChatRoomCharacterUpdate(target);
                                    let msg = "" + tmpname + " заставляет " + tgpname + " поднять руки над " + tgpr3 + " головой.";
                                    publicmsg(msg);
                                }
                            } else if (pose == "spreadeagle1") {
                                if (((target.ActivePose == null) || (target.ActivePose.includes('Yoked') == false) || (target.ActivePose.includes('Spread') == false)) &&
                                    ...
                                    ChatRoomCharacterUpdate(target);
                                    let msg = "" + tmpname + " заставляет " + tgpname + " поднять руки и развести ноги.";
                                    publicmsg(msg);
                                }
                            } else if (pose == "spreadeagle2") {
                                if (((target.ActivePose == null) || (target.ActivePose.includes('OverTheHead') == false) || (target.ActivePose.includes('Spread') == false)) &&
                                    ...
                                    PoseSetActive(target, "Spread");
                                    ChatRoomCharacterUpdate(target);
                                    let msg = "" + tmpname + " заставляет " + tgpname + " поднять руки над головой и развести ноги.";
                                    publicmsg(msg);
                                }
                            } else if (pose == "spreadlegs") {
                                if ((target.ActivePose != 'Spread') &&
                                    ...
                                    PoseSetActive(target, "Spread");
                                    ChatRoomCharacterUpdate(target);
                                    let msg = "" + tmpname + " заставляет " + tgpname + " развести " + tgpr3 + " ноги.";
                                    publicmsg(msg);
                                }
                            } else if (pose == "stand") {
                                if ((target.ActivePose != null) &&
                                    ...
                                    ChatRoomCharacterUpdate(target);
                                    CharacterRefresh(target);
                                    let msg = "" + tmpname + " помогает " + tgpname + " встать.";
                                    publicmsg(msg);
                                }
                            } else if (pose == "suspension") {
                                if ((target.ActivePose != 'Suspension') &&
                                    ...
                                    ChatRoomCharacterUpdate(target);
                                    let msg = "" + tmpname + " заставляет " + tgpname + " принять акробатическую позу в подвесе.";
                                    publicmsg(msg);
                                }
                            } else if (pose == "tapedhands") {
                                if ((target.ActivePose != 'TapedHands') &&
                                    ...
                                    ChatRoomCharacterUpdate(target);
                                    let msg = "" + tmpname + " заставляет " + tgpname + " вытянуть руки, как будто " + tgpr3 + " руки связаны скотчем.";
                                    publicmsg(msg);
                                }
                            } else if (pose == "reset") {
                                PoseSetActive(target, null);
    ...
    CommandCombine([{
        Tag: 'prison',
        Description: "(минуты): остаётся в онлайн-тюрьме Пандоры.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда prison должна сопровождаться числом больше 0. Она вызовет автоматический перезаход перед отправкой в тюрьму.\n" +
						"Если вы используете её, когда вы одни в комнате, будет автоматически создана новая комната.\n" +
						"Рекомендуется использовать её в существующей комнате Пандоры, в которую вы сначала вошли как обычный игрок.\n" +
						"Если вы используете её в существующей не-Пандора комнате, таймера не будет, но охранники Пандоры будут активны в течение запрошенного времени.\n" +
						"Для корректной работы во всех случаях убедитесь, что включены соответствующие настройки Погружения для автопересоздания комнат."
                infomsg(msg);
            } else {
                let minutes = args;
                if (minutes > 0) {
    ...
    CommandCombine([{
        Tag: 'quit',
        Description: "(действие): покинуть комнату.",
        Action: (args) => {
            if (noescape) {
                let msg = umsg1 + umsg3;
                infomsg(msg);
    ...
    CommandCombine([{
        Tag: 'randomize',
        Description: "(цель): команды naked + underwear + clothes + restrain.",
        Action: (args) => {
            let target = Player;
            if (args != "") target = TargetSearch(args);
            if (!target) return;
    ...
    CommandCombine([{
        Tag: 'removecollar',
        Description: ": временно снимает ошейник раба/владельца.",
        Action: () => {
            ServerSend("ChatRoomChat", {
    ...
    CommandCombine([{
        Tag: 'resetdifficulty',
        Description: ": сбрасывает сложность, тем самым выходя из неё.",
        Action: (args) => {
            if (args === "") {
                let msg = "<b>Предупреждение</b>: Сброс сложности повлечёт 7-дневный период ожидания для повторного изменения. Подтвердите, введя: <b>/resetdifficulty yes</b>";
                infomsg(msg);
            } else if (args === "yes") {
                Player.Difficulty = [];
                let msg = "Сложность сброшена, выберите новую в настройках.";
                infomsg(msg);
            }
        }
    }])
    ...
    CommandCombine([{
        Tag: 'resetinventory',
        Description: ": стирает ваш инвентарь.",
        Action: (args) => {
            if (args === "") {
                let msg = "<b>Предупреждение</b>: Вы потеряете много одежды и предметов, вам придётся покупать их снова. Подтвердите, введя: <b>/resetinventory yes</b>";
                infomsg(msg);
            } else if (args === "yes") {
                Player.Inventory = [];
                ServerPlayerInventorySync();
                let msg = "Выполнено. Посетите магазин, чтобы купить новую одежду и предметы.";
                infomsg(msg);
            }
        }
    }])
    ...
    CommandCombine([{
        Tag: 'resetnickname',
        Description: ": стирает ваш ник.",
        Action: (args) => {
            if (args === "") {
                let msg = "<b>Предупреждение</b>: Вы потеряете свой ник. Подтвердите, введя: <b>/resetnickname yes</b>";
                infomsg(msg);
            } else if (args === "yes") {
                ...
                let msg = "Выполнено. У вас больше нет ника.";
                infomsg(msg);
            }
        }
    }])
    ...
    CommandCombine([{
        Tag: 'restrain',
        Description: "(цель): добавляет случайные ограничения.",
        Action: (args) => {
            let target = Player;
            if (args != "") target = TargetSearch(args);
            if (!target) return;
            if (target == Player) {
                let msg = "Магические лазеры применяют случайные путы на теле " + tgpname + ".";
    ...
    CommandCombine([{
        Tag: 'roleplay',
        Description: "(роль): начинает играть роль BC",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда roleplay должна включать роль.\n" +
						"Вы сможете проверить изменения в своём профиле.\n" +
						" \n" +
						"Доступные роли:\n" +
						"clubmistress (клубная хозяйка), clubslave (клубный раб), doctor (доктор), escapedpatient (сбежавший пациент),\n" +
						"headmaid (старшая горничная), kidnapper (похититель), maid (горничная), magician (маг), magus (магус),\n" +
						"masterkidnapper (мастер-похититель), mistress (хозяйка), nurse (медсестра), oracle (оракул), patient (пациент),\n" +
						"permanentpatient (постоянный пациент), sage (мудрец), sorcerer (чародей), warlock (чернокнижник), witch (ведьма), wizard (волшебник).\n" +
						"Будьте осторожны с clubslave, вы будете вынуждены завершить контракт. Аналогичное предупреждение для escapedpatient.";
                infomsg(msg);
            } else {
                let role = args;
    ...
    CommandCombine([{
        Tag: 'rolequit',
        Description: "(роль или зона клуба): прекращает играть роль",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда rolequit должна включать роль или зону клуба.\n" +
						"Вы сможете проверить изменения в своём профиле.\n" +
						" \n" +
						"Доступные роли или зоны:\n" +
						"asylum (психушка) — перестать быть доктором, медсестрой, пациентом или постоянным пациентом.\n" +
						"clubslave — разорвать контракт клубного раба.\n" +
						"ggts — покинуть тренировку GGTS (вернуться к уровню 0).\n" +
						"kidnapper — перестать быть похитителем или мастером-похитителем.\n" +
						"magician — перестать быть одной из 8 магических ролей.\n" +
						"management или mistress — перестать быть хозяйкой или клубной хозяйкой.\n" +
						"sorority или maid — перестать быть горничной или старшей горничной.";
                infomsg(msg);
            } else {
                let role = args;
                if (role == "asylum") {
    ...
    CommandCombine([{
        Tag: 'safeworditem',
        Description: ": удаляет определённый предмет.",
        Action: () => {
            let msg = "У вас есть 5 секунд, чтобы нажать на цель и выбрать область. В случае успеха будет возвращено. Если нет — попробуйте снова.";
            infomsg(msg);
            setTimeout(function() {
    ...
    CommandCombine([{
        Tag: 'search',
        Description: ": открывает поиск чата в текущем лобби.",
        Action: () => {
            RoomToGame();
            CommonSetScreen("Online", "ChatSearch");
        }
    ...
    CommandCombine([{
        Tag: 'setdevious',
        Description: "(время) (античит): устанавливает время и античит для всех текущих коварных замков на вас.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда setdevious должна сопровождаться двумя числами для времени замка и опции античита.\n" +
						"Время указывается в часах. Минимум 1 час. Используйте 0 для неограниченного времени.\n" +
						"Используйте ? если хотите, чтобы время было выбрано игрой случайно (от 1 до 720 часов).\n" +
						"Для опции античита используйте 0 ( = отключён) или 1 ( = включён).\n" +
						"Примечание: настройки не будут автоматически отражены в интерфейсе DOGS, вы увидите их только после полного перезахода.\n" +
						"Рекомендуется сделать этот полный перезаход сразу после корректного выполнения команды для сохранения обновлённых данных.";
                infomsg(msg);
            } else {
                ...
                if ((ltd > -1) && (acd > -1) && (acd < 2)) {
                    ...
                    if (DOGS) {
                        ...
                        if (DOGSdata.deviousPadlock.state == true) {
                            ...
                            if (devious != 0) {
                                infomsg("Настройки ваших коварных замков обновлены. Пожалуйста, сделайте сейчас полный перезаход для сохранения обновлённых данных!");
                                ChatRoomCharacterUpdate(Player);
    ...
    CommandCombine([{
        Tag: 'sfchaste',
        Description: "(модель) (передний щит) (задний щит) (защита от взлома) (режим оргазма): изменяет настройки надетого Футуристического Пояса Целомудрия.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда sfchaste должна сопровождаться 5 числами для модели, переднего щита, заднего щита, защиты от взлома и режима оргазма.\n" +
						" \n" +
						"Доступные модели: \n" +
						"0 Прототип - 1 Высокая безопасность\n" +
						"2 Тренировочный - 3 Нео\n" +
						" \n" +
						"Доступные передние щиты:\n" +
						"0 Открыт - 1 Заперт\n" +
						" \n" +
						"Доступные задние щиты:\n" +
						"0 Открыт - 1 Заперт\n" +
						" \n" +
						"Доступные защиты от взлома:\n" +
						"0 Отключена - 1 Пояс - 2 Все предметы\n" +
						" \n" +
						"Доступные режимы оргазма:\n" +
						"0 Разрешить - 1 Наказать";
                infomsg(msg);
            } else {
                if (InventoryGet(Player, "ItemPelvis") != null) {
                    if (InventoryGet(Player, "ItemPelvis").Asset.Name == "FuturisticChastityBelt") {
                        ...
                        if ((msf > -1) && (msf < 4) && (fsf > -1) && (fsf < 2) && (bsf > -1) && (bsf < 2) && (tsf > -1) && (tsf < 3) && (osf > -1) && (osf < 2)) {
                            ...
                            ChatRoomCharacterUpdate(Player);
                            let msg = "Настройки вашего Футуристического Пояса Целомудрия изменены.";
                            infomsg(msg);
                        }
                    }
                }
    ...
    CommandCombine([{
        Tag: 'shock',
        Description: ": (слот) (чувствительность) (интенсивность): изменяет режим шокового устройства в определённом слоте.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда shock должна сопровождаться двумя (или тремя) числами:\n" +
						"- число для нужного слота:\n" +
						"0 = Руки - 1 = Грудь - 2 = Ягодицы - 3 = Устройства - 4 = Шея - 5 = Шейные аксессуары - 6 = Соски - 7 = Таз - 8 = Вульва\n" +
						" \n" +
						"- число для чувствительности шокового устройства в этом слоте:\n" +
						"0 = Выкл - 1 = Низкая - 2 = Средняя - 3 = Высокая \n" +
						"- число для интенсивности ударов током:\n" +
						"1 = Низкая - 2 = Средняя - 3 = Высокая \n" +
						"Обратите внимание, что большинству устройств не нужен последний параметр, так как они ссылаются на уровень, сочетающий чувствительность и интенсивность!\n" +
						"Некоторые устройства нельзя отключить. Для Пояса Послушания используйте 0 (отключён) или 1 (включён).\n" +
						"Эта команда не поддерживает Футуристический Пояс Целомудрия и Футуристический Тренировочный Пояс.";
                infomsg(msg);
            } else {
                let Target = "";
                let Item = "";
                ...
                let ms = stringSol2[1];
                let mi = stringSol2[2];
                let msg = "Настройки изменены для одного из ваших шоковых устройств!";
                if ((slot > -1) && (slot < 9)) {
    ...
    CommandCombine([{
        Tag: 'sleep',
        Description: "(цель): использует снотворное на себе или другом игроке.",
        Action: (args) => {
    ...
    CommandCombine([{
        Tag: 'slowleave',
        Description: "(действие): медленно покидает комнату.",
        Action: (args) => {
            if (noescape) {
                let msg = umsg1 + umsg3;
                infomsg(msg);
                ...
                let message = "";
                if (args === "") {
                    message = " медленно направляется к двери."
                } else {
                    message = ' '.repeat(1) + args;
                }
                let msg = "" + tmpname + message;
    ...
    CommandCombine([{
        Tag: 'solidity',
        Description: "(значение) (цель): изменяет прочность большинства текущих пут.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда solidity должна сопровождаться числом от 1 до 1000 и опционально целью.\n" +
						"Чтобы освободиться от специаль	пут (Футуристический Ящик, Деревянная Стойка, Костюм с нарукавниками), используйте значение 1.";
                infomsg(msg);
            } else {
                let stringSol1 = args;
                let stringSol2 = stringSol1.split(/[ ,]+/);
                ...
                if ((solidity < 1) || (solidity > 1000)) {
                    let msg = "Значение прочности должно быть от 1 до 1000.";
                    infomsg(msg);
                } else {
                    if ((targetname == null) && (solidity > 0) && (solidity < 100)) {
                        if ((noescape) && (solidity < 20)) {
                            ...
                            if ((extrasol != 0) && (solidity == 1)) {
                                ...
                                let msg1 = "Магические лазеры заставляют исчезнуть специальные путы, удерживавшие " + tmpname + " в плену.";
                            ...
                            ChatRoomCharacterUpdate(Player);
                            let msg2 = "Прочность большинства текущих пут изменена.";
                            infomsg(msg2);
                        }
                    } else {
                        let target = TargetSearch(targetname);
                        if ((target != null) && (target.AllowItem == true) && (solidity > 0) && (solidity < 100) && (target.OnlineSharedSettings.UBC != undefined)) {
                            ...
                            if (IsTargetProtected(target)) {
                                ...
                                if ((extrasol != 0) && (solidity == 1)) {
                                    ...
                                    let msg1 = "Магические лазеры заставляют исчезнуть специальные путы, удерживавшие " + tgpname + " в плену.";
                                ...
                                let msg2 = "Прочность большинства текущих пут игрока " + tgpname + " изменена игроком " + tmpname + ".";
                                publicmsg(msg2);
                                ChatRoomCharacterUpdate(target);
                            }
                        }
    ...
    CommandCombine([{
        Tag: 'spin',
        Description: "(цель) (опция): позволяет получить доступ к колесу фортуны цели, даже если оно не отображается.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда spin должна сопровождаться целью, чьё колесо фортуны вас интересует, и опционально режимом.\n" +
						"Доступные режимы:\n" +
						"a = автоматическое настоящее вращение (только опции, выбранные создателем колеса)\n" +
						"i = информация о максимальном количестве опций на колесе\n" +
						"r = полностью случайное вращение (включает также опции, не выбранные создателем колеса)\n" +
						"Совет: используйте режим i перед режимом r, это корректно инициализирует сообщения.\n" +
						"Обратите внимание, что ролевая игра отключается режимами a и r!";
                infomsg(msg);
            } else {
                let stringSol1 = args;
                let stringSol2 = stringSol1.split(/[ ,]+/);
                ...
                if ((target != null) && (target.OnlineSharedSettings.UBC != undefined)) {
                    ...
                    if (IsTargetProtected(target)) {
                        ...
                        if (!InventoryAvailable(target, "WheelFortune", "ItemDevices")) {
                            let msg = "Не повезло! У этого игрока нет колеса фортуны.";
                            infomsg(msg);
                        } else {
    ...
    CommandCombine([{
        Tag: 'stalk',
        Description: "(режим заикания) (текст): говорит один раз в указанном режиме заикания.",
        Action: (_, command, args) => {
            let help = "Команда stalk должна сопровождаться числом от 1 до 4 для режима заикания и словами, которые вы хотите сказать.\n" +
					"Обратите внимание, что её нельзя использовать, когда вы находитесь в «постоянном» режиме заикания.\n" +
					" \n" +
					"Доступные режимы заикания:\n" +
					"1 лёгкое заикание\n" +
					"2 обычное заикание\n" +
					"3 тяжёлое заикание\n" +
					"4 полное заикание";
            ...
            if (st != 0) {
                infomsg('Вы не можете использовать эту команду, потому что вы находитесь в "постоянном" режиме заикания');
                return;
            }
            let [, , ...message] = command.split(" ");
            let msg = message?.join(" ");
            if (!msg) {
                infomsg("Пожалуйста, укажите текст после режима заикания.");
                return;
            }
            if (dolltalk === true && IsDollTalk(msg) === false) {
                infomsg(umsg4);
    ...
    CommandCombine([{
        Tag: 'store',
        Description: ": покинуть чат-комнату, войти в магазин, показать скрытые предметы.",
        Action: () => {
            Asset.forEach(e => {
                if (e.Value < 0) e.Value = 1;
            });
    ...
    CommandCombine([{
        Tag: 'superdice',
        Description: "(грани): бросает суперкубик. ",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда superdice должна сопровождаться числом от 2 до 999999999.";
                infomsg(msg);
            } else {
                let sides = args;
                ...
                Result.push(Roll);
                let msg = "" + tmpname + " бросает суперкубик с " + sides + " гранями. Результат: " + Result + ".";
                publicmsg(msg);
            }
        }
    }])
    ...
    CommandCombine([{
        Tag: 'theme',
        Description: "(число): изменяет цветовую тему чата.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда theme должна сопровождаться числом от 0 до 3.";
                infomsg(msg);
            } else {
                let theme = args;
                if ((theme > -1) && (theme < 4)) {
    ...
    CommandCombine([{
        Tag: 'thmlogin',
        Description: "(опции) показывает/скрывает Титры и/или NPC на экране входа, когда используется мод Themed",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда thmlogin может использоваться только если мод Themed включён.\n" +
						"Она должна сопровождаться числом от 1 до 3.\n" +
						"1 = Титры - 2 = NPC - 3 = 1 + 2.\n" +
						"";
                if (Player.Themed != undefined) msg = msg + "Текущий статус:";
                infomsg(msg);
            } else {
                if (Player.Themed != undefined) {
                    if ((args == 1) || (args == 3)) {
                    ...
                    if ((args > 0) && (args < 4)) {
                        ...
                        let msg = "Настройки экрана входа изменены!";
                        infomsg(msg);
                    }
                }
            }
    ...
    CommandCombine([{
        Tag: 'timercell',
        Description: "(минуты): находиться в изоляторе.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда timercell должна сопровождаться числом больше 0.";
                infomsg(msg);
            } else {
                let minutes = args;
                if (minutes > 0) {
                    let msg = "" + tmpname + " схвачен(а) двумя горничными и заперт(а) в таймер-комнате на " + minutes + " минут.";
                    publicmsg(msg);
                    DialogLentLockpicks = false;
                    RoomToGame();
                    CellLock(minutes);
    ...
    CommandCombine([{
        Tag: 'title1',
        Description: "(титул): выбирает новый титул (от A до D).",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда title1 должна сопровождаться названием титула.\n" +
                    "Также изменяться навыки игрока, чтобы соответствовать требованиям титула.\n" +
                    "Вы можете посмотреть изменения на странице профиля.\n" +
                    " \n" +
                    "Доступные титулы:\n" +
    ...
    CommandCombine([{
        Tag: 'title2',
        Description: "(титул): выбирает новый титул (от E до K).",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда title2 должна сопровождаться названием титула.\n" +
                    "Также изменяться навыки игрока, чтобы соответствовать требованиям титула.\n" +
                    "Вы можете посмотреть изменения на странице профиля.\n" +
                    " \n" +
                    "Доступные титулы:\n" +
    ...
    CommandCombine([{
        Tag: 'title3',
        Description: "(титул): выбирает новый титул (от L до Q).",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда title3 должна сопровождаться названием титула.\n" +
                    "Также изменяться навыки игрока, чтобы соответствовать требованиям титула.\n" +
                    "Вы можете посмотреть изменения на странице профиля.\n" +
                    " \n" +
                    "Доступные титулы:\n" +
    ...
    CommandCombine([{
        Tag: 'title4',
        Description: "(титул): выбирает новый титул (от R до Z).",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда title4 должна сопровождаться названием титула.\n" +
                    "Также изменяться навыки игрока, чтобы соответствовать требованиям титула.\n" +
                    "Вы можете посмотреть изменения на странице профиля.\n" +
                    " \n" +
                    "Доступные титулы:\n" +
    ...
    CommandCombine([{
        Tag: 'totalrelease',
        Description: "(цель): снимает все путы, ошейник, упряжь, целомудрие, игрушки.",
        Action: (args) => {
            let target = Player;
            if (args != "") target = TargetSearch(args);
            if (!target) return;
            if (target == Player) {
                if (noescape) {
                    ...
                    let msg = "Магические лазеры заставляют исчезнуть все путы и игрушки на теле " + tmpname + ".";
                ...
                if ((target.AllowItem == true) && (target.OnlineSharedSettings.UBC != undefined)) {
                    ...
                    if (IsTargetProtected(target)) {
                        ...
                        let msg = "Магические лазеры заставляют исчезнуть все путы и игрушки на теле " + tgpname + ".";
    ...
    CommandCombine([{
        Tag: 'tplistadd',
        Description: "(номер участника): добавляет игрока в список тех, кому разрешено телепортировать вас.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда tplistadd должна сопровождаться номером участника, которому вы разрешаете телепортировать вас.";
                infomsg(msg);
            } else {
                let member = args * 1;
                let List;
    ...
    CommandCombine([{
        Tag: 'tplistremove',
        Description: "(номер участника): удаляет игрока из списка тех, кому разрешено телепортировать вас.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда tplistremove должна сопровождаться номером участника, которому больше не разрешено телепортировать вас.";
                infomsg(msg);
            } else {
                let member = args * 1;
                let List;
    ...
    CommandCombine([{
        Tag: 'tplistshow',
        Description: ": отображает список игроков, которым разрешено телепортировать вас.",
        Action: (args) => {
            let List;
            if (Player.OnlineSharedSettings.Tplist == undefined) {
                List = [];
    ...
    CommandCombine([{
        Tag: 'trsee',
        Description: ": (визор) (модуль глушения) (подбородочный ремень): изменяет настройки надетого Техно-Шлема",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда trsee должна сопровождаться 3 числами для визора, модуля глушения и подбородочного ремня.\n" +
						" \n" +
						"Доступные визоры:\n" +
						"0 Без визора - 1 прозрачный\n" +
						"2 лёгкая тонировка - 3 сильная тонировка\n" +
						"4 непрозрачный - 5 гипнотический\n" +
						" \n" +
						"Доступные модули глушения:\n" +
						"0 без модуля\n" +
						"1 лёгкий\n" +
						"2 тяжёлый\n" +
						"3 шумоподавление\n" +
						" \n" +
						"Доступные опции подбородочного ремня:\n" +
						"0 Без подбородочного ремня\n" +
						"1 подбородочный ремень";
                infomsg(msg);
            } else {
                if (InventoryGet(Player, "ItemHood") != null) {
                    if (InventoryGet(Player, "ItemHood").Asset.Name == "TechnoHelmet1") {
                        ...
                        if ((vtr > -1) && (vtr < 6) && (dtr > -1) && (dtr < 4) && (ctr > -1) && (ctr < 2)) {
                            ...
                            ChatRoomCharacterUpdate(Player);
                            let msg = "Настройки вашего Техно-Шлема изменены.";
                            infomsg(msg);
                        }
                    }
                }
    ...
    CommandCombine([{
        Tag: 'uhelp',
        Description: "(категория): отображает команды ULTRAbc.",
        Action: (args) => {
            if (args === "") {
                let msg = "Справка UBC организована по категориям. Используйте <b>/uhelp</b> (категория). Список категорий:\n" +
						"<b>admin</b> = команды только для администраторов чат-комнат.\n" +
						"<b>bondage</b> = команды, связанные с бондажом.\n" +
						"<b>character</b> = команды, связанные с вашим персонажем.\n" +
						"<b>chat</b> = команды с дополнительными возможностями в чат-комнате.\n" +
						"<b>clothing</b> = команды, связанные с одеждой.\n" +
						"<b>escape</b> = команды, связанные с побегом.\n" +
						"<b>fun</b> = команды, связанные с весельем, болью и удовольствием.\n" +		
						"<b>info</b> = команды, дающие информацию.\n" +
						"<b>maps</b> = команды, связанные с гибридными комнатами и картами.\n" +
						"<b>misc</b> = справка, информация, вход и команды Ulist.\n" +
						"<b>settings</b> = команды для настройки ULTRAbc.\n" +
						"<b>talking</b> = команды, связанные с речью.\n" +
						"<b>visual</b> = команды, связанные с анимацией и фоном.\n" +
						"<b>zones</b> = команды, связанные с игровыми зонами.\n" +
						"Несколько команд требуют или позволяют указать цель. Это может быть настоящее имя, ник или номер участника.\n" +
						"Посетите также нашу <a href='https://github.com/tetris245/ULTRAbc/wiki' target='_blank'>Вики</a> и присоединяйтесь к нашему <a href='https://steamcommunity.com/groups/ULTRAbc' target='_blank'>Steam-сообществу</a>";
                infomsg(msg);
            }
            if (args === "admin") {
				let msg = "Команды администратора\n" +
					"<b>/autokick</b> = включает автокик для аккаунтов возрастом 0 дней.\n" +
					"<b>/bg1</b> (число) = использует фон Bondage College/Teacher как пользовательский фон. /bg1 для списка.\n" +
					"<b>/bg2</b> (число) = использует фон Bondage Brawl как стандартный фон. /bg2 для списка.";
				infomsg(msg);
			}
			if (args === "bondage") {
				let msg = "Команды бондажа - * = больше информации при использовании\n" +
					"<b>/autoheart</b> = надевает сердечные замки на себя и настраивает их. *.\n" +
					"<b>/hint</b> (цель) (подсказка) = добавляет или изменяет подсказку для всех текущих замков с паролем.\n" +
					"<b>/lock</b> = добавляет замки на все запираемые предметы. *.\n" +
					"<b>/outfit</b> = восстанавливает/сохраняет/загружает наряд (включая путы). *\n" +
					"<b>/pet</b> (цель) = становится полностью связанным питомцем.\n" +
					"<b>/randomize</b> (цель) = команды naked + underwear + clothes + restrain.\n" +
					"<b>/restrain</b> (цель) = добавляет случайные путы.\n" +
					"<b>/setdevious</b> = настраивает все ваши текущие коварные замки. *\n" +
					"<b>/solidity</b> (значение) (цель) = изменяет прочность большинства текущих пут. Значение от 1 до 99.\n" +
					"<b>/spin</b> (цель) (опция) = доступ к любому колесу фортуны, даже скрытому. *\n" +
					"<b>/weaken</b> = ослабляет все ваши навыки на час.";
				infomsg(msg);
			}
			if (args === "character") {
				let msg = "Команды персонажа - * = больше информации при использовании\n" +
					"<b>/cname</b> (пользовательское имя) = создаёт пользовательское имя. *\n" +
					"<b>/cowner</b> (номер участника) (дни владения) (имя владельца) = устанавливает пользовательского владельца. *\n" +
					"<b>/ctitle</b> (пользовательский титул) = создаёт пользовательский титул. *\n" +
					"<b>/difficulty</b> (число) = изменяет сложность игры. *\n" +
					"<b>/maxstatistics</b> = даёт максимальную статистику.\n" +
					"<b>/permission</b> (число) = изменяет ваше разрешение на предметы *\n" +
					"<b>/resetinventory</b> = стирает ваш инвентарь.\n" +
					"<b>/resetnickname</b> = стирает ваш ник.\n" +
					"<b>/roleplay</b> (роль) = начинает роль. *\n" +
					"<b>/rolequit</b> (роль или зона клуба) = прекращает играть роль. *\n" +
					"<b>/title1</b> (новый титул) = выбирает новый титул (от A до D). *\n" +
					"<b>/title2</b> (новый титул) = выбирает новый титул (от E до K). *\n" +
					"<b>/title3</b> (новый титул) = выбирает новый титул (от L до Q). *\n" +
					"<b>/title4</b> (новый титул) = выбирает новый титул (от R до Z). *";
				infomsg(msg);
			}
			if (args === "chat") {
				let msg = "Команды чата - * = больше информации при использовании\n" +
					"<b>/bio</b> (цель) = просмотр профиля любого игрока в чат-комнате.\n" +
					"<b>/font</b> (новый шрифт) (размер) = изменяет шрифт в BC. *\n" +
					"<b>/frlist</b> = даёт доступ к списку друзей в текущем лобби.\n" +
					"<b>/search</b> = открывает поиск чата в текущем лобби.\n" +
					"<b>/theme</b> (число) = изменяет цветовую тему чата. Число от 0 до 3.";
				infomsg(msg);
			}
			if (args === "clothing") {
				let msg = "Команды одежды - * = больше информации при использовании\n" +
					"<b>/clothes</b> (цель) = меняет одежду.\n" +
					"<b>/naked</b> (цель) = снимает одежду.\n" +
					"<b>/outfit</b> (опции) = восстанавливает/сохраняет/загружает наряд (включая путы). *\n" +
					"<b>/underwear</b> (цель) = меняет нижнее бельё.\n" +
					"<b>/wexport</b> (цель) = полностью экспортирует наряд в формате UBC/BCG.\n" +
					"<b>/wimport1</b> (цель) = импортирует одежду + путы в формате UBC/BCG.\n" +
					"<b>/wimport2</b> (цель) = импортирует одежду + путы + косплей в формате UBC/BCG.\n" +
					"<b>/wimport3</b> (цель) = полностью импортирует наряд в формате UBC/BCG.\n" +
					"<b>/wrobe</b> (цель) = полностью открывает гардероб цели.";
				infomsg(msg);
			}
			if (args === "escape") {
				let msg = "Команды побега - * = больше информации при использовании\n" +
					"<b>/boost</b> = усиливает все ваши навыки на час.\n" +
					"<b>/infolock</b> = даёт дополнительную информацию (код, пароль, оставшееся время) о замке на надетом предмете в выбранном слоте.\n" +
					"<b>/quit</b> (действие) = покидает комнату.\n" +
					"<b>/removecollar</b> = временно снимает ошейник раба/владельца.\n" +
					"<b>/resetdifficulty</b> = сбрасывает сложность, тем самым выходя из неё.\n" +
					"<b>/safeworditem</b> = удаляет определённый предмет. *\n" +
					"<b>/solidity</b> (значение) (цель) = изменяет прочность большинства текущих пут. Используйте низкие значения для побега! Значение 1 для освобождения от специальных пут.\n" +
					"<b>/totalrelease</b> (цель) = снимает все путы, ошейник, упряжь, целомудрие, игрушки.\n" +
					"<b>/unlock</b> (цель) (тип замка) = снимает все замки или только указанный тип. *\n" +
					"<b>/untie</b> (цель) = снимает все путы.";
				infomsg(msg);
			}
            if (args === "fun") {
				let msg = "Команды веселья - * = больше информации при использовании\n" +
					"** = скрипты должны быть разрешены в настройках BC\n" +
					"<b>/cum</b> = вызывает оргазм (во всех случаях).\n" +
					"<b>/horny</b> = устанавливает ваш уровень возбуждения (во всех случаях). *\n" +
					"<b>/invisible</b> (цель) = переходит или отправляет в режим невидимости. **\n" +
					"<b>/poof</b> (действие) = очень быстро покидает клуб. Действие опционально (по умолчанию = исчезает).\n" +
					"<b>/sfchaste</b> (опции) = изменяет настройки надетого Футуристического Пояса Целомудрия. *\n" +
					"<b>/shock</b> (слот) (чувствительность) (интенсивность) = изменяет режим шокового устройства в определённом слоте. *\n" +
					"<b>/sleep</b> (цель) = использует снотворное.\n" +
					"<b>/slowleave</b> (действие) = медленно покидает комнату.\n" +
					"<b>/superdice</b> (грани) = бросает суперкубик. Грани от 2 до 999999999.\n" +
					"<b>/vibe</b> (слот) (режим) = изменяет режим надетого вибратора в определённом слоте. *\n" +
					"<b>/visible</b> (цель) = возвращается или возвращает в видимый режим. **";
				infomsg(msg);
			}
			if (args === "info") {
				let msg = "Команды информации - * = больше информации при использовании\n" +		
					"<b>/maproom</b> = даёт информацию об игроках на текущей карте.\n" +
					"<b>/mbsroom</b> = информация о MBS-колёсах в текущей комнате.\n" +
					"<b>/mstatus</b> = отображает текущий статус Мунера.\n" +                 
					"<b>/uhelp</b> (категория) = отображает команды ULTRAbc. *\n" +
					"<b>/umods</b> (цель) = информация о модах, используемых всеми игроками или конкретным игроком в текущей чат-комнате.\n" +
					"<b>/uroom</b> = информация о пользователях UBC/Uwall в текущей комнате.";                  
				infomsg(msg);
			}
			if (args === "maps") {
				let msg = "Команды карт - * = больше информации при использовании\n" +
					"<b>/mapfog</b> = переключает туман в текущей комнате с картой.\n" +
					"<b>/mapforce</b> = принудительно включает доступ к карте в текущей обычной комнате (только для вас).\n" +
					"<b>/mapkeys</b> (номер ключа) (действие) = находит или теряет все ключи или определённый ключ для текущей комнаты с картой. *\n" +
					"<b>/maproom</b> = информация об игроках на текущей карте.\n" +
					"<b>/mapx</b> (x-позиция) = изменяет вашу X-координату на карте.\n" +
					"<b>/mapy</b> (y-позиция) = изменяет вашу Y-координату на карте.\n" +
					"<b>/mapz</b> (цель) = даёт координаты на карте.\n" +
					"<b>/mapzoom</b> (значение) = изменяет уровень приближения в комнатах с картой.\n" +
					"<b>/tplistadd</b> (номер участника) = добавляет игрока в список тех, кому разрешено телепортировать вас.\n" +
					"<b>/tplistremove</b> (номер участника) = удаляет игрока из списка тех, кому разрешено телепортировать вас.\n" +
					"<b>/tplistshow</b> = отображает список игроков, которым разрешено телепортировать вас.";
				infomsg(msg);
			}
			if (args === "misc") {
				let msg = "Разные команды - * = больше информации при использовании\n" +
					"<b>/callubc</b> = устанавливает GUI UBC (использовать, если не удалось при инициализации).\n" +
					"<b>/login</b> (имя аккаунта) (пароль) = входит в новый аккаунт.\n" +                 
					"<b>/pmenu</b> = прямой доступ к экрану Настроек.\n" +
					"<b>/relog</b> = делает перезаход.\n" +
					"<b>/thmlogin</b> (опции) = показывает/скрывает Титры и/или NPC на экране входа, когда используется мод Themed. *\n" +
					"<b>/ulistadd</b> (номер участника) = добавляет игрока в список тех, кому разрешено обходить Uwall.\n" +
					"<b>/ulistremove</b> (номер участника) = удаляет игрока из списка тех, кому разрешено обходить Uwall.\n" +
					"<b>/ulistshow</b> = отображает список игроков в вашем Ulist.\n" +                 
					"<b>/xmenu</b> = прямой доступ к экрану Расширений.";
				infomsg(msg);
			}
			if (args === "settings") {
				let msg = "Команды настроек\n" +
					"<b>/bglist</b> = отображает список всех доступных стандартных фонов.\n" +
					"<b>/bgshow1</b> (номер фона) = отображает локально кликабельную ссылку на определённый стандартный фон и встроенное изображение.\n" +
					"<b>/bgshow2</b> (номер фона) = отправляет в чат ссылку на определённый стандартный фон. Кликабельная ссылка и встраивание возможны при использовании с функцией WCE.\n" +
					"<b>/killpar</b> = удаляет локально сохранённые параметры UBC/Moaner.\n" +
					"<b>/message</b> (опция) (сообщение) = создаёт пользовательские сообщения для определённой команды. *";
				infomsg(msg);
			}
			if (args === "talking") {
				let msg = "Команды речи - * = больше информации при использовании\n" +
					"<b>/atalk</b> (текст) = говорит один раз как животное. *\n" +
					"<b>/btalk</b> (текст) = говорит один раз как малыш.\n" +
					"<b>/gtalk</b> (режим речи) (текст) = говорит один раз в указанном режиме кляп-речи. *\n" +
					"<b>/murmur</b> (НомерУчастника|Имя|Ник) (Сообщение) = отправляет шёпот игроку. Сообщения об ошибках не исчезнут.\n" +
					"<b>/ping</b> (НомерУчастника) (Сообщение) = отправляет сигнал игроку. Ошибки сигнала не исчезнут.\n" +
					"<b>/stalk</b> (режим заикания) (текст) = говорит один раз в указанном режиме заикания. *";
				infomsg(msg);
			}
			if (args === "visual") {
				let msg = "Команды визуала - * = больше информации при использовании\n" +
					"<b>/allcolor</b> (код цвета) (категория) (цель) = изменяет цвет текущих элементов в указанной категории. *\n" +
					"<b>/colorchanger</b> (анимация) = анимация со сменой цвета. *\n" +
					"<b>/itemcolor</b> (код цвета) = изменяет цвет предмета в выбранном слоте. *\n" +
					"<b>/layerset</b> (номер слоя) (код цвета) = изменяет цвет слоя предмета в сохранённом Слоте Предмета. *\n" +
					"<b>/layershow</b> = информация о цветах и сохранение Слота Предмета.\n" +
					"<b>/pose2</b> (поза) (цель) = изменяет позу любого игрока. *\n" +
					"<b>/trsee</b> (визор) (модуль глушения) (подбородочный ремень) = изменяет настройки надетого Техно-Шлема. * \n" +
					"<b>/vrsee</b> (фон) (режим) (игра) = изменяет настройки надетого VR-шлема. *";
				infomsg(msg);
			}
			if (args === "zones") {
				let msg = "Команды зон - * = больше информации при использовании\n" +
					"<b>/asylum</b> (минуты) = входит в психушку, обходя требования. Укажите минуты, если вы пациент.\n" +
					"<b>/cgame</b> (зона) = запускает карточную игру с NPC. *\n" +
					"<b>/chess</b> (сложность) = запускает шахматную игру. *\n" +
					"<b>/college</b> = входит в колледж, обходя требования.\n" +
					"<b>/game</b> (мини-игра) = запускает мини-игру. *\n" +
					"<b>/ggts</b> (минуты) (уровень) = входит в тренировку GGTS в психушке на указанное время. Уровень от 1 до 6.\n" +
					"<b>/keydeposit</b> (часы) = хранит ваши ключи в безопасности в хранилище. Возможно более 7 дней (168 часов). \n" +
					"<b>/mission</b> (тип миссии) = принудительно запускает миссию проникновения. *\n" +
					"<b>/npcprison</b> (минуты) = остаётся в NPC-тюрьме Пандоры. Возможно более 60 минут.\n" +
					"<b>/prison</b> (минуты) = остаётся в онлайн-тюрьме Пандоры. Возможно более 1 дня (1440 минут). *\n" +
					"<b>/store</b> = Идёт в магазин. Показывает скрытые предметы.\n" +
					"<b>/timercell</b> (минуты) = остаётся в изоляторе. Возможно более 60 минут.";
				infomsg(msg);
            }
        }
    }])
    ...
    CommandCombine([{
        Tag: 'ulistadd',
        Description: "(номер участника): добавляет игрока в список тех, кому разрешено обходить Uwall.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда ulistadd должна сопровождаться номером участника, которому вы разрешаете обходить Uwall.";
                infomsg(msg);
            } else {
                let member = args * 1;
                let List;
    ...
    CommandCombine([{
        Tag: 'ulistremove',
        Description: "(номер участника): удаляет игрока из списка тех, кому разрешено обходить Uwall.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда ulistremove должна сопровождаться номером участника, которому больше не разрешено обходить Uwall.";
                infomsg(msg);
            } else {
                let member = args * 1;
                let List;
    ...
    CommandCombine([{
        Tag: 'ulistshow',
        Description: "отображает список игроков, которым разрешено обходить Uwall.",
        Action: (args) => {
            let List;
            if (Player.OnlineSharedSettings.Ulist == undefined) {
                List = [];
	...
	CommandCombine([{
        Tag: 'umods',
        Description: "(цель): отображает информацию о модах, используемых всеми игроками или конкретным игроком в текущей чат-комнате.",
        Action: (args) => {
    ...
    CommandCombine([{
        Tag: 'underwear',
        Description: "(цель): меняет нижнее бельё.",
        Action: (args) => {
            let target = Player;
            if (args != "") target = TargetSearch(args);
            if (!target) return;
            if (target == Player) {
                let msg = "Магические лазеры надевают на " + tmpname + " случайное нижнее бельё.";
                ...
                if ((target.AllowItem == true) && (target.OnlineSharedSettings.UBC != undefined)) {
                    ...
                    if (IsTargetProtected(target)) {
                        ...
                        let msg = "Магические лазеры надевают на " + tgpname + " случайное нижнее бельё.";
    ...
    CommandCombine([{
        Tag: 'unlock',
        Description: "(цель) (тип замка): снимает все замки или только указанный тип замка с указанной цели.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда unlock:\n" +
						"<b>/unlock</b> (цель) (тип замка).\n" +
						"Цель всегда должна быть указана.\n" +
						"Все замки любого типа будут сняты, если вы не укажете тип замка.\n" +
						" \n" +
						"Типы замков:\n" +
						"1 Металлический (по умолчанию при неверном значении) - 2 Эксклюзивный\n" +
						"3 Сложный - 4 Высокая безопасность - 5 Пандора\n" +
						"6 Хозяйка - 7 Любовник - 8 Владелец - 9 Пять минут\n" +
						"10 Комбинация - 11 Стоп-слово - 12 Пароль\n" +
						"13 Таймер Хозяйки - 14 Таймер Любовника - 15 Таймер Владельца\n" +
						"16 Таймер-пароль - 17 Лучший друг - 18 Таймер ЛД\n" +
						"19 Семья - 20 Непристойный герб - 21 Коварный - 22 Сердечный\n" +
						"Замки 21 и 22 могут быть сняты всеми, только если игроки используют модифицированную версию модов DOGS или AFC.";
                infomsg(msg);
            } else {
                let uw = 0;
                ...
                if ((target != null) && ((target == Player) || (target.AllowItem == true)) && (target.OnlineSharedSettings.UBC != undefined)) {
                    ...
                    if (tmpname == tgpname) {
                        if (noescape) {
                            ...
                            let msg = "Магические лазеры заставляют исчезнуть замки на теле " + tgpname + ".";
    ...
    CommandCombine([{
        Tag: 'untie',
        Description: "(цель): снимает все путы.",
        Action: (args) => {
            let target = Player;
            if (args != "") target = TargetSearch(args);
            if (!target) return;
            if (target == Player) {
                if (noescape) {
                    ...
                    let msg = "Магические лазеры заставляют исчезнуть путы на теле " + tmpname + ".";
                ...
                if ((target.AllowItem == true) && (target.OnlineSharedSettings.UBC != undefined)) {
                    ...
                    if (IsTargetProtected(target)) {
                        ...
                        let msg = "Магические лазеры заставляют исчезнуть путы на теле " + tgpname + ".";
    ...
    CommandCombine([{
        Tag: 'uroom',
        Description: ": даёт информацию о пользователях UBC и защите Uwall в текущей чат-комнате.",
        Action: () => {
            ChatRoomCharacter.forEach(character => {
                const command = "uroom";
                UBCinfo(character, command);
    ...
    CommandCombine([{
        Tag: 'vibe',
        Description: ": (слот) (режим): изменяет режим надетого вибратора в определённом слоте.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда vibe должна сопровождаться двумя числами:\n" +
						"- число для нужного слота:\n" +
						"0 = Обувь - 1 = Грудь - 2 = Ягодицы - 3 = Клитор/Головка\n" +
						"4 = Устройства - 5 = Ступни - 6 = Соски\n" +
						"7 = Пирсинг сосков - 8 = Таз - 9 = Вульва/Пенис\n" +
						" \n" +
						"- число для режима вибратора в этом слоте:\n" +
						"0 = Выкл - 1 = Низкий - 2 = Средний - 3 = Высокий - 4 = Максимум\n" +
						"5 = Случайный - 6 = Нарастающий - 7 = Дразнящий - 8 = Запрет - 9 = На грани\n" +
						"Обратите внимание, что режимы 5-9 доступны не на всех вибраторах!\n" +
						"Для Пояса Тяжёлой Нагрузки, Научно-фантастических Трусиков Удовольствия и Стеклянной Банки: 5, 6 или 7 = Разрешить оргазм\n" +
						"Эта команда не поддерживает Футуристический Тренировочный Пояс и Знак Суккуба."
                infomsg(msg);
            } else {
                let Target = "";
                let Item = "";
                ...
                let msg = "Режим изменён для одного из ваших вибраторов!";
                if ((slot > -1) && (slot < 10)) {
    ...
    CommandCombine([{
        Tag: 'visible',
        Description: ": (цель): возвращается или возвращает в видимый режим.",
        Action: (args) => {
            let target = Player;
            if (args != "") target = TargetSearch(args);
            if (!target) return;
            if (target == Player) {
                let msg = "" + tmpname + " внезапно становится видимым(ой) для всех.";
                ...
                if ((target.AllowItem == true) && (target.OnlineSharedSettings.UBC != undefined)) {
                    tgpname = getNickname(target);
                    if (target.OnlineSharedSettings.ScriptPermissions.Hide.permission == 0) {
                        let msg = "Чтобы использовать команду visible на других игроках, они сначала должны разрешить Скрипты в настройках BC.";
                        infomsg(msg);
                        return;
                    }
                    if (IsTargetProtected(target)) {
                        ...
                        let msg = "" + tgpname + " внезапно становится видимым(ой) для всех.";
    ...
    CommandCombine([{
        Tag: 'vrsee',
        Description: "(фон) (режим) (игра): изменяет настройки надетого VR-шлема.",
        Action: (args) => {
            if (args === "") {
                let msg = "Команда vrsee должна сопровождаться 3 числами для фона, режима и игры.\n" +
						" \n" +
						"Доступные фоны:\n" +
						"0 Без фона - 1 Виртуальный мир\n" +
						"2 Темница - 3 Высокие технологии\n" +
						"4 Древние руины - 5 Транс\n" +
						" \n" +
						"Доступные режимы:\n" +
						"0 Сквозной\n" +
						"1 VR выкл\n" +
						"2 VR вкл\n" +
						"3 VR вкл + Скрыть путы\n" +
						" \n" +
						"Доступные игры:\n" +
						"0 Без игры\n" +
						"1 Кинки-темница";
                ...
                if (InventoryGet(Player, "ItemHead") != null) {
                    if (InventoryGet(Player, "ItemHead").Asset.Name == "InteractiveVRHeadset") {
                        ...
                        if ((bvr > -1) && (bvr < 6) && (fvr > -1) && (fvr < 4) && (gvr > -1) && (gvr < 2)) {
                            ...
                            ChatRoomCharacterUpdate(Player);
                            let msg = "Настройки вашего VR-шлема изменены.";
                            infomsg(msg);
                        }
                    }
                }
    ...
    CommandCombine([{
        Tag: 'weaken',
        Description: ": ослабляет все ваши навыки на час.",
        Action: () => {
            SkillSetModifier(Player, "Bondage", -5, 3600000);
            SkillSetModifier(Player, "Dressage", -5, 3600000);
            SkillSetModifier(Player, "Evasion", -5, 3600000);
            ...
            SkillSetModifier(Player, "SelfBondage", -5, 3600000);
            SkillSetModifier(Player, "Willpower", -5, 3600000);
            let msg = "Вы чувствуете, что все ваши навыки ослаблены. Изменения можно увидеть в панели информации.";
            infomsg(msg);
        }
    }])
	...
	CommandCombine([{
        Tag: 'wexport',
        Description: "(цель): полностью экспортирует наряд в формате UBC/BCG.",
        Action: (args) => {
            let target = Player;
            if (args != "") target = TargetSearch(args);
            if (!target) return;
     ...
     CommandCombine([{
        Tag: 'wimport1',
        Description: "(цель): импортирует одежду + путы в формате UBC/BCG.",
        Action: (args) => {
            let target = Player;
            if (args != "") target = TargetSearch(args);
            if (!target) return;
            ...
            let appinp = prompt('Пожалуйста, введите awcode (Совместимый с BCG).', '');
            C = target;
    ...
    CommandCombine([{
        Tag: 'wimport2',
        Description: "(цель): импортирует одежду + путы + косплей в формате UBC/BCG.",
        Action: (args) => {
            let target = Player;
            if (args != "") target = TargetSearch(args);
            if (!target) return;
    ...
    CommandCombine([{
        Tag: 'wimport3',
        Description: "(цель): полностью импортирует наряд в формате UBC/BCG.",
        Action: (args) => {
            let target = Player;
            if (args != "") target = TargetSearch(args);
            if (!target) return;
    ...
    CommandCombine([{
        Tag: 'wrobe',
        Description: "(цель): открывает гардероб цели.",
        Action: (args) => {
            if (args === "") {
    ...
    CommandCombine([{
        Tag: 'xmenu',
        Description: ": прямой доступ к меню Расширений.",
        Action: () => {
            ExtClick();
        }
    }])
